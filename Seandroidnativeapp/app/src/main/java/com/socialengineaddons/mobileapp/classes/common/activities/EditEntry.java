        ...
        switch (currentSelectedOption) {
            ...
            case ConstantVariables.CONTACT_INFO_MENU_TITLE:
                ...
                if (mFormType != null && !mFormType.isEmpty()) {
                    ...
                    mToolBarTitle = mBundle.getString(ConstantVariables.KEY_TOOLBAR_TITLE,getResources().getString(R.string.edit));
                    mSuccessMessage = mBundle.getString(ConstantVariables.KEY_SUCCESS_MESSAGE,getResources().getString(R.string.successful_edit));
                }
                break;
