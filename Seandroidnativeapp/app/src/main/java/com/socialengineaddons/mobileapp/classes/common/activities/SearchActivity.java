...
import com.socialengineaddons.mobileapp.classes.common.adapters.SimpleSearchAdapter;
...
import com.socialengineaddons.mobileapp.classes.modules.globalSearch.GlobalSearchFragment;
...
public class SearchActivity extends FormActivity implements View.OnClickListener, SearchView.OnQueryTextListener, SearchView.OnSuggestionListener {
    ...
    public String QUERY_STRING = "query", mPackageName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTagName = bundle.getString("tag");
        mTagId = bundle.getString("tag_id");
        categoryValue = bundle.getString(ConstantVariables.CATEGORY_VALUE);
        categoryId = bundle.getString(ConstantVariables.CATEGORY_ID);
        switch (currentSelectedOption) {
            case ConstantVariables.FORUM_MENU_TITLE:
                categoryForumTopic = bundle.getString(ConstantVariables.CATEGORY_FORUM_TOPIC);
                break;
        }

        isDashBoardSearch = bundle.getBoolean(ConstantVariables.IS_SEARCHED_FROM_DASHBOARD, false);
        isHashTagSearch = bundle.getBoolean(ConstantVariables.HASTAG_SEARCH, false);
    ...
    private void getSearchUrl(String query) {
        ...
        if (currentSelectedOption != null && (!isDashBoardSearch || isAdvSearch)) {
            ...
            switch (currentSelectedOption) {
                ...
                default:
                    mQuery = bundle.getString(ConstantVariables.SEARCH_TITLE, query);
                    customSearchUrl = bundle.getString(ConstantVariables.URL_STRING, "search");
                    mPackageName = bundle.getString(ConstantVariables.KEY_PACKAGE_NAME);
                    break;
            }
    ...
    public void loadSearchFragment() {
        ...
        try {
            ...
            searchParamsBundle.putBoolean(ConstantVariables.IS_SEARCH_MODE, true);
            switch (currentSelectedOption) {
                case ConstantVariables.EVENT_MENU_TITLE:
                case ConstantVariables.GROUP_MENU_TITLE:
                case ConstantVariables.EVENT_TITLE:
            ...
            if (currentSelectedOption != null && (!isDashBoardSearch || isAdvSearch)) {
                switch (currentSelectedOption) {
                    ...
                    case ConstantVariables.ALBUM_TITLE:
                        ...
                        searchParamsBundle.putBoolean("isHideFilter", true);
                        break;
                    ...
                    default:
                        if (mPackageName != null) {
                            GlobalFunctions.invokeMethod(mPackageName, ConstantVariables.SEARCH_METHOD_NAME, searchParamsBundle);
                        }
                        break;
                }
            ...
            if (fragment != null && !isFinishing()) {
                ...
                String searchString = searchParamsBundle.getString("search");
                if (currentSelectedOption.equals(ConstantVariables.USER_MENU_TITLE) || currentSelectedOption.equals(ConstantVariables.USER_TITLE)) {

                    if (searchString != null && searchString.isEmpty()) {
                        searchParamsBundle.putString("search", mSearchView.getQuery().toString().trim());
                    } else {
                        searchParamsBundle.putString("search", searchString);
                    }
                }
