...
public class ImageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ImageAdapter(Activity activity, List<ImageViewList> photoList,
        ...
        divider = (int) mActivity.getResources().getDimension(R.dimen.padding_2dp);
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        if(!mIsReactionsAdapter){
            ...
            /* Add some divider/padding in between photos for displaying multi photos in aaf */
            if (position == 0) {
                imageHolder.imageView.setPadding(0, 0, 0, divider);
            } else if (position == 1) {
                imageHolder.imageView.setPadding(0, 0, divider, 0);
            }
