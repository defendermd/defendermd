...
public class ManageDataAdapter extends ArrayAdapter<Object> implements OnMenuClickResponseListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
                        ...
                        switch (currentSelectedOption) {
                            ...
                            case "sitepage":
                                ...
                                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                                    listItemHolder.mListImageIcon.setClipToOutline(true);
                                }
                                break;
        ...
        switch (type) {
            case TYPE_ITEM:
                ...
                if (listItems.getMenuArray() != null && listItems.getMenuArray().length() > 0) {
    ...
    private static class ListItemHolder {
        ...
        TextView mLikeCount, mCommentCount, ownerInfo, memberInfo, mDuration, mUpdatedDate, mFollowCount, mMemberCount, mShortDescription;
        TextView mDateIcon, mLocationIcon, mLikeIcon, mCommentIcon, mRatingIcon, mListImageClosed;
        ImageView mOptionIcon, mPlayIcon, mIvOverlay;
        TextView mEventLocation, mEventTime, tvDistance, tvReviewCount;;
