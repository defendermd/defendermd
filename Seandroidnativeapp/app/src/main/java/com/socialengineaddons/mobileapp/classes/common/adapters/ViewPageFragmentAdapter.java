...
import com.socialengineaddons.mobileapp.classes.common.fragments.AdvModulesInfoTabFragment;
...
import com.socialengineaddons.mobileapp.classes.common.fragments.InfoFragment;
import com.socialengineaddons.mobileapp.classes.common.fragments.InfoTabFragment;
...
import com.socialengineaddons.mobileapp.classes.common.ui.CustomFloatingView;
...
import com.socialengineaddons.mobileapp.classes.modules.advancedVideos.AdvVideoBrowseFragment;
 ...
 */
public class ViewPageFragmentAdapter extends BaseFragmentAdapter implements
    ...
    private Map<Integer, BaseFragment> mPageReferenceMap = new HashMap<>();
    ...
    public int mPhotoTabPosition = 0, mMapTabPosition = 0;
    ...
    public ViewPageFragmentAdapter(Context context, FragmentManager fragmentManager,
        ...
        addVideosTab();
        getViews();
//        if(mCurrentSelectedModule.equals("userProfile") && PreferencesUtils.isPrimeMessengerEnabled(mContext)){
//            showFabIcons(-1, true);
//        }
    }
    ...
    public void getViews() {
        ...
        if (messageView != null) {
            ...
            if (PreferencesUtils.isPrimeMessengerEnabled(mContext)) {
                messageView.setIconPadding(mContext.getResources().getDimensionPixelSize(R.dimen.dimen_5dp));
    ...
    public int getFragmentPosition(Fragment fragment) {
        return (mFragmentMap.get(fragment) != null) ? mFragmentMap.get(fragment) : mFragmentMap.size() - 1;
    }
     ...
     */
    public BaseFragment getFragmentToBeLoaded(int position) {

        String tabName;
        BaseFragment loadFragment = null;
        try {
            ...
            switch (tabName) {
                ...
                case "update":
                    ...
                    bundle.putBoolean(ConstantVariables.SET_NESTED_SCROLLING_ENABLED, mBundle.getBoolean(ConstantVariables.SET_NESTED_SCROLLING_ENABLED, true));
                    break;
                ...
                case "video":
                case "videos":
                    /*Play video in pip window only when video tab is displayed on user profile and channels page */
                    if (mCurrentSelectedModule.equals("userProfile") || mCurrentSelectedModule.equals(ConstantVariables.ADV_VIDEO_CHANNEL_MENU_TITLE)) {
                    ...
                    } else if (mCurrentSelectedModule.equals(ConstantVariables.ADV_VIDEO_CHANNEL_MENU_TITLE) || isSiteVideoEnabled == 1) {
                        loadFragment = AdvVideoUtil.getBrowsePageInstance();
                    } else {
                ...
                case "photos":
                    /* Don't need to display fab create option again in photos fragment
                    because it's already displayed here in this class */
                    bundle.putInt(ConstantVariables.CAN_UPLOAD, 0);
                    switch (mCurrentSelectedModule) {
                        case ConstantVariables.SITE_PAGE_MENU_TITLE:
                            loadFragment = AlbumUtil.getBrowsePageInstance();
                            bundle.putBoolean("isSitePageAlbums", true);
                ...
                case "advevents":
                    ...
                    bundle.putString(AdvEventsUtil.EVENT_TYPE, AdvEventsUtil.SITE_GROUP);
                    break;
                ...
                case "where-to-buy":
                    ...
                    break;
                case "project":
                    loadFragment = BrowseProjectsFragments.newInstance(bundle);
                    break;
                default:
                    ...
                    if (object != null && object instanceof Fragment) {
                        loadFragment = (BaseFragment) object;
                    }
                    loadFragment = (loadFragment == null) ? new BlankFragment() : loadFragment;
                    break;
            }
