...
package com.socialengineaddons.mobileapp.classes.common.ads.communityAds;
...
public class CommunityAdsHolder extends RecyclerView.ViewHolder {
    ...
    public static void inflateAd(final CommunityAdsList mCommunityAd,
        ...
        if (adView.findViewById(R.id.native_ad_cover) != null) {
            ...
            imageLoader.setProductCoverImage(mCommunityAd.getmCommunityAdImage(), nativeAdCover);
        ...
        if (adView.findViewById(R.id.native_ad_icon) != null) {
            ...
            imageLoader.setProductCoverImage(mCommunityAd.getmCommunityAdImage(), nativeAdIcon);
        }
