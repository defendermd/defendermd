...
public class AlertDialogWithAction {
    ...
    public void showAlertDialogForSignUpError(String errorType) {
        ...
        switch (errorType) {
            ...
            case "subscription_fail":
                mDialogBuilder.setMessage(mContext.getResources().getString(R.string.subscription_fail_error_message));
                break;
            default:
    ...
    public void showAlertDialogWithAction(String headerTitle, String message, String buttonTitle,
        ...
        mDialogBuilder.setNegativeButton(mContext.getResources().getString(R.string.cancel), onClickListener);
        AlertDialog alertDialog = mDialogBuilder.create();
        alertDialog.show();
    }
    ...
    public void showAlertDialogWithCancel(String headerTitle,String message, String buttonTitle,
                                          DialogInterface.OnClickListener onClickListener) {
