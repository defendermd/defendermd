...
public class FormActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static JSONObject mHostForm, buyerFormValues, _formObject, subProfileFields;
    ...
    private FormMultiOptions mFormMultiOptions, mRadioFormMultiOptions;
    // -- widgets
    ...
    public static String getAttribByPropertyForSignupFields(String propertyName, String attributeName, String isFieldsKey) {
        JSONArray formArray = subProfileFields.optJSONArray(propertyName);
        if (formArray != null) {
            for (int i = 0; i < formArray.length(); i++) {
                if (formArray.optJSONObject(i).opt("name").equals(propertyName)) {
                    return formArray.optJSONObject(i).optString(attributeName);
    ...
    public static boolean setRegistryByPropertyForSingupFields(String propertyName, JSONObject parent, String child, String elementType, int order) {
        try {
            ...
            if (child != null && !child.trim().equals("")) {
                ...
                if (elementType != null && !elementType.isEmpty() && elementType.equals("MultiCheckbox")) {
                    JSONObject temp = subProfileFields.optJSONObject(propertyName);
                    JSONObject multiChild = (temp != null && temp.optJSONObject("multiChild") != null) ? temp.optJSONObject("multiChild") : new JSONObject();
                    multiChild = FormActivity.updateMultiChild(multiChild, 1, 0);
                    multiChild.put(child, order);
                    element.put("multiChild", multiChild);
                } else {
                    element.put("child", child);
                }
                subProfileFields.putOpt(propertyName, element);

                JSONArray subFormElements = subProfileFields.optJSONArray(child);
                if (subFormElements != null) {
                    for (int i = 0; i < subFormElements.length(); i++) {
                        if (subFormElements.optJSONObject(i).optBoolean("hasSubForm")) {
                            ...
                            subProfileFields.putOpt(subFormElements.optJSONObject(i).optString("name"), childElement);
                        }
                    }
                }
    ...
    public static boolean setRegistryByProperty(String propertyName, JSONObject parent, String child, String elementType, int order) {
        try {
            ...
            if (child != null && !child.trim().equals("")) {
                element.put("parent", parentKey);
                if (elementType != null && !elementType.isEmpty() && elementType.equals("MultiCheckbox")) {
                    JSONObject temp = _formObject.optJSONObject(propertyName);
                    JSONObject multiChild = (temp != null && temp.optJSONObject("multiChild") != null) ? temp.optJSONObject("multiChild") : new JSONObject();
                    multiChild = FormActivity.updateMultiChild(multiChild, 1, 0);
                    multiChild.put(child, order);
                    element.put("multiChild", multiChild);
    ...
    public static String getRegistryByPropertyForSignupFields(String propertyName, String key) {
        if (getSignupProfileFields() != null && getSignupProfileFields().optJSONObject(propertyName) != null) {
            return getSignupProfileFields().optJSONObject(propertyName).optString(key);
        }
        return null;
    }
    ...
    public static String getRegistryByProperty(String propertyName, String key) {
        if (getFormObject() != null && getFormObject().optJSONObject(propertyName) != null) {
    ...
    public static JSONObject getRegistryByProperty(String propertyName, String key, String type) {
        if (getFormObject() != null && getFormObject().optJSONObject(propertyName) != null) {
            return getFormObject().optJSONObject(propertyName).optJSONObject(key);
        }
        return null;
    }

    public static JSONObject getRegistryByPropertyForSignupFields(String propertyName, String key, String type) {
        if (getFormObject() != null && getFormObject().optJSONObject(propertyName) != null) {
            return getFormObject().optJSONObject(propertyName).optJSONObject(key);
        }
        return null;
    ...
    public static void setMultiChild(String propertyName, String key, JSONObject multiChild) {
        if (getFormObject() != null && getFormObject().optJSONObject(propertyName) != null) {
            try {
                getFormObject().optJSONObject(propertyName).put("multiChild", multiChild);
            } catch (JSONException e) {
                e.printStackTrace();
            }
        }
     ...
     */
    public View generateForm(JSONObject data, JSONObject subProfileFields, boolean createForm, String currentSelectedOption,
                             String firstName, String lastName) {

        first_name = firstName;
        last_name = lastName;
        this.subProfileFields = subProfileFields;
        return generateForm(data, createForm, currentSelectedOption);
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        if (FormEditText.popupWindow != null && FormEditText.popupWindow.isShowing()) {
    ...
    public View generateForm(JSONObject data, boolean createForm, String currentSelectedOption) {
        int margin = (int) (mContext.getResources().getDimension(R.dimen.margin_5dp) /
                ...
                if (createForm) {
                    switch (currentSelectedOption) {
                        ...
                        case ConstantVariables.ADD_TO_FRIEND_LIST:
                            createDiaryDescription = mContext.getResources().getString(R.string.create_list_description);
                            addToDiaryDescription = mContext.getResources().getString(R.string.add_to_list_description);
                            break;
                    ...
                    switch (currentSelectedOption) {
                        ...
                        case "sellingForm":
                            ...
                            break;
                        default:
                            formArray = (data.optJSONArray("editForm") != null) ? data.optJSONArray("editForm") : formArray;
                    }
                }
                ...
                if (formArray != null) {
                    ...
                    if (currentSelectedOption.equals(ConstantVariables.SETTING_NOTIFICATIONS)) {
                        ...
                        for (int j = 0; j < formArray.length(); j++) {
                            ...
                            if (j == 0) {
                                widget = getTextViewWidget(mContext, SCHEMA_KEY_STRING,
                            ...
                            if (category != null) {
                                widget = getTextViewWidget(mContext, SCHEMA_KEY_STRING, category, true);
                                _widgets.add(widget);
                            }
                    ...
                    if (data != null) {
                        ...
                        for (int i = 0; i < data.length(); i++) {
                            ...
                            if (!jsonArrayKey.equals("") && !jsonArrayKey.isEmpty()) {
                                widget = getTextViewWidget(mContext, SCHEMA_KEY_STRING, jsonArrayKey, true);
                                _widgets.add(widget);
                            }
        ...
        for (int i = 0; i < _widgets.size(); i++) {
            ...
            if (mCurrentSelectedOption.equals(ConstantVariables.PAYMENT_METHOD_CONFIG)) {
        ...
        switch (mCurrentSelectedOption) {
            ...
            case ConstantVariables.BLOG_MENU_TITLE:
                ...
                if (createForm) {
                    continueButton.setText(mContext.getResources().getString(R.string.create_desc_button_title));
                } else {
                    continueButton.setText(mContext.getResources().getString(R.string.edit_desc_button_title));
                }
            ...
            case "message":
                ...
                layoutParams.setMargins(0, mContext.getResources().getDimensionPixelSize(R.dimen.margin_10dp),
                        0, 0);
                LinearLayout uploadVideoLayout = new LinearLayout(mContext);
                ...
                TextView uploadVideoText = new TextView(mContext);
                uploadVideoText.setText(mContext.getResources().getString(R.string.my_device_video_msg));
                uploadVideoText.setLayoutParams(layoutParams);
                uploadVideoText.setLayoutParams(layoutParams);
                uploadVideoLayout.addView(uploadVideoText);
                Button uploadVideo = new Button(mContext);
                uploadVideo.setText(mContext.getResources().getString(R.string.upload));
...
//                uploadVideoLayout.setId(R.id.upload_video);
                ...
                uploadVideo.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent createEntry = new Intent(mContext, CreateNewEntry.class);
    ...
    public void getFormWidgets(JSONArray jsonArray, boolean createForm) {
        ...
        for (int j = 0; j < jsonArray.length(); j++) {
            ...
            widget = getWidget(mContext, fieldName, jsonObject, fieldLabel, hasValidator, createForm,
        ...
        try {
            ...
            switch (currentSelectedOption) {
                ...
                default: {
                    ...
                    if (jsonString.optJSONArray("editForm") != null) {
                    ...
                    if (!widget.getPropertyName().equals("searchGuests")
                        ...
                        if (!widget.getPropertyName().equals("text")) {
                            if (widget.is_hasValidator() && widget.getValue().isEmpty() &&
                                ...
                                if (strErrorTag == null) {
                                    strErrorTag = widget.getPropertyName();
                                }
                                //TODO, API_Discussion
                            } else if (widget.getPropertyName().equals("overview") && overviewText != null) {
                                params.put("overview", overviewText);

                            } else {
                                params.put(widget.getPropertyName(), widget.getValue());

                                if (widget.getPropertyName().contains("location") && locationObject != null) {
                                    params.put("locationParams", locationObject.toString());
                                }
                            }
                        }
        ...
        if (property != null) {
            ...
            switch (type) {
                ...
                case FormActivity.SCHEMA_KEY_BOOL_UPPER:
                    return new FormCheckBox(context, property, _widgets, mCurrentSelectedOption, _map);

                case FormActivity.SCHEMA_KEY_FILE:
                case FormActivity.SCHEMA_KEY_FILE1:
                    return new FormPicker(context, name, mCurrentSelectedOption, createForm, property);

                case FormActivity.SCHEMA_KEY_RADIO:
                case FormActivity.SCHEMA_KEY_RADIO_SMALLER:
                    ...
                    if (jsonObject != null && jsonObject.length() != 0) {
                        if (mCurrentSelectedOption.equals(ConstantVariables.SHIPPING_METHOD)) {
                ...
                case FormActivity.SCHEMA_KEY_DATE_LOWER:
                    return new FormPicker(context, name, hasValidator, property.optString("format"), property);

                case FormActivity.SCHEMA_KEY_RATING:
                    return new FormPicker(context, name, label, hasValidator, true, property);

                case FormActivity.SCHEMA_KEY_BLOCKED_LIST:
                    return new FormBlockedUsers(mContext, name, label, hasValidator, description);
                ...
                case FormActivity.SCHEMA_KEY_DUMMY:
                    return new FormTextView(context, name, hasValidator, false, label, property, currentSelectedOption, _widgets, _map);
                case FormActivity.SCHEMA_KEY_COUNTRY_CODE:
                    return new FormCountryCode(context, name, hasValidator, property);

            }
        } else {
            return new FormTextView(context, name, hasValidator, false, label, null, currentSelectedOption, _widgets, _map);
        }
        return null;
    }
    ...
    private View inflateAddOptionButton() {
        ...
        LinearLayout addPollOptionLayout = new LinearLayout(mContext);
        addPollOptionLayout.setOrientation(LinearLayout.VERTICAL);

        Button addAnotherOption = new Button(mContext);
        addAnotherOption.setText(mContext.getResources().getString(R.string.add_another_poll_option));
    ...
    protected FormWidget getTextViewWidget(Context context, String name, String label, boolean isNeedToAddPadding) {
        return new FormTextView(context, name, false, isNeedToAddPadding, label, null, mCurrentSelectedOption, _widgets, _map);
    }
