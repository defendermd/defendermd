...
public class AdvBrowseCategoriesFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public void setMenuVisibility(final boolean visible) {
        ...
        if (visible && !isVisibleToUser && mFragmentName != null && !mFragmentName.isEmpty() && !mFragmentName.equals("site_page_categories")) {
            makeRequest();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (getArguments() != null) {
            args = getArguments();
            mCategoriesUrl = args.getString(ConstantVariables.URL_STRING, "");
            mFragmentName =  args.getString(ConstantVariables.FRAGMENT_NAME, "");
        }
        ...
        mRecyclerView.setPadding(mContext.getResources().getDimensionPixelOffset(R.dimen.dimen_3dp),
                mContext.getResources().getDimensionPixelOffset(R.dimen.dimen_3dp),
                mContext.getResources().getDimensionPixelOffset(R.dimen.dimen_3dp),
                mContext.getResources().getDimensionPixelOffset(R.dimen.dimen_50dp));
        ...
        if (mFragmentName.equals("site_page_categories")) {
    ...
    public void addItemsToList(JSONObject jsonObject){
        ...
        if(mDataResponse != null && mDataResponse.length() > 0) {
            ...
            for (int i = 0; i < mDataResponse.length(); i++) {
                ...
                String image = (images == null) ? jsonDataObject.optString("image_icon") : images.optString("image");
