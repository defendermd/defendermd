        ...
        try {
            ...
            if (!responseObject.optString("price").equals("0") && !responseObject.optString("price").isEmpty()) {
                ...
                mProfileFieldsObject.put(mContext.getResources().getString(R.string.price),
                        CurrencyUtils.getCurrencyConvertedValue(mContext, responseObject.optString("currency"),
            ...
            // Follow & Review buttons are not displaying on Page Info Tab
            ...
            if (!mCurrentSelectedModule.equals(ConstantVariables.SITE_PAGE_MENU_TITLE) && body != null && !body.isEmpty()) {
