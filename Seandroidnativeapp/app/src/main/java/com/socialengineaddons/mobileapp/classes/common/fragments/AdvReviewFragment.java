...
public class AdvReviewFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener,
    ...
    public void addDataToList(JSONObject jsonObject) {
        ...
        if (jsonObject != null) {
            try {
                ...
                if (!mCurrentSelectedModule.equals(ConstantVariables.SITE_PAGE_MENU_TITLE) && ((AppCompatActivity) mContext).getSupportActionBar() != null
