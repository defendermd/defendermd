package com.socialengineaddons.mobileapp.classes.common.listeners;
 ...
 * <p>
 * <pre>
 * view.setOnTouchListener(new OnSlideDownDismissTouchListener(view, null, // Optional
 *                                   // token/cookie
 *                                   // object
 *     new OnSlideDownDismissTouchListener.OnDismissCallback() {
 ...
 * </pre>
 */
public class OnSlideDownDismissTouchListener implements View.OnTouchListener {
    //TODO, We can work for left to right & vice-versa swipe to dismiss.
    ...
    // Fixed properties
    private View mView, mParentView;
     ...
     */
    public OnSlideDownDismissTouchListener(View view, View parentView, Object token,
        ...
        mView = (parentView != null ) ? parentView : view;
        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (Math.abs(deltaY) > mViewWidth / 2 && mSwiping) {
                    dismiss = true;
                } else if (mMinFlingVelocity <= absVelocityY
...
//                            .translationY(mViewWidth)
                    ...
                    // cancel
                    mView.animate().translationY(0).alpha(1f)
    ...
    /**
     * The callback interface used by {@link OnSlideDownDismissTouchListener} to
