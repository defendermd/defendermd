package com.socialengineaddons.mobileapp.classes.common.ui.BottomNavigation;
 ...
 */
public final class BottomNavigationBehavior<V extends View> extends VerticalScrollingBehaviour<V> {
    ...
    private static int mSnackbarHeight = -1;
    ...
    public static void updateBehaviour(boolean update) {
        isApply = update;
    }
