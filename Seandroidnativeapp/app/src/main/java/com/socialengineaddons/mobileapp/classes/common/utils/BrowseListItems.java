...
public class BrowseListItems {
    ...
    int mListItemId, mPhotoCount, mCommentCount, mMemberCount, mUserId , mTotalItemCount, mIsRequestInvite;
    int mViewCount, mLikeCount, mDuration, mVideoType, mVideoRating, mRatingCount, mIsGroupAdmin;
    JSONArray menuArray, mRatingParams, mFilterResponse;
    boolean mIsRequestSent, mIsLoading, allowToView, mShowAddPeople, mGroupPublished, isLessTextShowing, mIsFilterSelected;
    int mIsOwner, mRsvp, mClosed, mEventId, mEventCount, mSubscribed, mWatched, mSticky, mJoined, mProfileRsvpValue;
    JSONObject mMemberMenus, responseObject, bannerObject, parentObject, mSortFilterObject;
    int mTotalTracks, canEdit, mTotalPlayCount, mContentId, mIsClosed;
    String mModuleType, mAlbumId, mRedirectUrl, mContentUrl, mModuleName, mBody, mBrowseListName, mCategoryId, mCategoryName;
    ...
    public boolean isAdminApprovalRequired, isAdminApproved, isManageView;

    //For Notifications
    JSONObject mNotificationObject, mSubjectResponse, mObjectResponse, paramsObject;
    ...
    boolean mIsShowOptionMenu, isFollowingMember, mCanMessage;
    ...
    */
    ...
    private String mListImage, mPriceTagImage, mListUrl, mContact, mDistance, mStartPrice;
    ...
    private JSONObject mVideoOverlayObject;
    ...
    public boolean isSendMessage() {
        return storyObject.optInt("isSendMessage") == 1;
    }
    ...
    public String getStoryOverlayImage() {
        if (storyObject != null && storyObject.optJSONObject("video_overlay_image") != null) {
            return storyObject.optJSONObject("video_overlay_image").optString("url");
        }
        return null;
    }
    ...
    */
    ...
    public BrowseListItems(String imgurl,String listTitle,String createdDate,int likeCount,
        ...
        mVideoOverlayObject = videoOverlayObject;
    ...
    public BrowseListItems(String imgurl,String listTitle,String createdDate,int likeCount, int commentCount,
                           ...
                           int event_id, String videoUrl,String contentUrl, int videoType,
                           JSONArray menuJsonArray, JSONObject videoOverlayObject){
    ...
    public BrowseListItems(int isSiteMember, int userId, String imgurl, String ownerTitle,
                           ...
                           String friendShipType, JSONArray menuArray, boolean isManage){
    ...
    public BrowseListItems(int notificationId,int userId,int subjectId,int objectId,int read,
                           ...
                           JSONObject subjectResponse, JSONObject objectResponse,
                           JSONArray actionBodyParamsArray, JSONObject paramsObject) {
        mUserId = userId;
    ...
    */
    ...
    public BrowseListItems(String imgurl, String hostImageUrl, String listTitle, String ownerTitle, int memberCount,
                           int listItemId, boolean viewAllowed, String location, String startTime, int ownerId,
                            String hostType, int hasMultipleDates, int featured, int sponsored, String startPrice, int occurrenceId){
        mBrowseImgUrl = imgurl;
    ...
    public BrowseListItems (int packageId, JSONObject packageObject, JSONObject descriptionObject,
                            JSONArray menuArray, String title, boolean isPackageUpgrade) {
    ...
    public BrowseListItems(String imgurl, String listTitle, int listItemId, boolean viewAllowed,
                           int likeCount, int followCount, int isClosed, String location, int reviewCount,
                           int rating, int featured, int sponsored, String contact, boolean canMessage, String distance){
        mBrowseImgUrl = imgurl;
        mBrowseListTitle = listTitle;
        mListItemId = listItemId;
        allowToView = viewAllowed;
        ...
        mContact = contact;
        mDistance = distance;
        mCanMessage = canMessage;
    }

    //For Manage site page
    public BrowseListItems(String imgurl, String listTitle, int likeCount, int followCount,
                           int listItemId, JSONArray menuJsonArray, String location, String distance, int reviewCount, int rating){
        mBrowseImgUrl = imgurl;
        mBrowseListTitle = listTitle;
        mLikeCount = likeCount;
        mFollowCount = followCount;
    ...
    public BrowseListItems(String imgurl, String listTitle, String ownerTitle, int listItemId, boolean viewAllowed,
                           int likeCount, int followCount, int featured, int sponsored, int closed, String shortDescription){
        mBrowseImgUrl = imgurl;
        mBrowseListTitle = listTitle;
        mBrowseListOwnerTitle = ownerTitle;
        mListItemId = listItemId;
    ...
    public BrowseListItems(String imgurl, String listTitle, String ownerTitle, int likeCount, int memberCount,
                           int listItemId, JSONArray menuJsonArray, int closed, String shortDescription){
        mBrowseImgUrl = imgurl;
        mBrowseListTitle = listTitle;
        mBrowseListOwnerTitle = ownerTitle;
        mLikeCount = likeCount;
    ...
    // Browse Album filter categories
    public BrowseListItems(String categoryId, String categoryName, boolean isFilter) {
    ...
    public JSONObject getmVideoOverlayObject() {
        return mVideoOverlayObject;
    }

    public void setmSortFilterObject(JSONObject mSortFilterObject) {
        this.mSortFilterObject = mSortFilterObject;
    }

    public JSONObject getmSortFilterObject() {
        return mSortFilterObject;
    }

    public void setmIsFilterSelected(boolean mIsFilterSelected) {
        this.mIsFilterSelected = mIsFilterSelected;
    }

    public boolean getmIsFilterSelected() {
        return mIsFilterSelected;
    }
