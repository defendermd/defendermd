...
import com.socialengineaddons.mobileapp.classes.modules.advancedEvents.AdvEventsProfilePage;
import com.socialengineaddons.mobileapp.classes.modules.advancedGroups.AdvGroupsProfile;
...
import com.socialengineaddons.mobileapp.classes.modules.directoryPages.SitePageProfileActivity;
...
import com.socialengineaddons.mobileapp.classes.modules.packages.PackageView;
...
import com.socialengineaddons.mobileapp.classes.modules.store.ShippingMethods;
...
public class GutterMenuUtils {
    ...
    private int mSelectedRsvpValue = 0, mPosition, mListingTypeId, mOwnerId;
     ...
     * @param ownerId ownerId of item.
     */
    public void showOptionMenus(Menu menu, JSONArray gutterMenus, String currentSelectedModule,
                                BrowseListItems browseListItems, int ownerId) {
        this.mOwnerId = ownerId;
        showOptionMenus(menu, gutterMenus, currentSelectedModule, browseListItems);
    }
                ...
                try {
                    ...
                    switch (mMenuName) {
                        ...
                        case "cart":
                            ...
                            imageView.setImageDrawable(cartIcon);
                ...
                if (!isRequestFromViewPage) {
                    ...
                    switch (mCurrentSelectedModule) {
                        case ConstantVariables.SITE_PAGE_MENU_TITLE:
                            if (SitePageProfileActivity.sIsPageFollowed == 0) {
                                mMenuLabel = mContext.getResources().
    ...
    public void onMenuItemSelected(View view, int id, JSONArray menuArray, boolean isBrowsePage,
        ...
        switch (mMenuName) {
            ...
            case "user_profile_send_message":
                if (PreferencesUtils.isPrimeMessengerEnabled(mContext)) {
                    MessageCoreUtils.openTwoUsersConversation(mContext, String.valueOf(mBrowseListItems.getUserId()),
                            mBrowseListItems.getUserDisplayName(),
                            mBrowseListItems.getUserProfileImageUrl());
                } else {
            ...
            case "messageOwner":
                if (PreferencesUtils.isPrimeMessengerEnabled(mContext)) {
                    //TODO, need to cross check for the display name and url.
                    MessageCoreUtils.openTwoUsersConversation(mContext, String.valueOf(mBrowseListItems.getUserId()),
                            mBrowseListItems.getUserDisplayName(),
                            mBrowseListItems.getUserProfileImageUrl());
                } else {
            ...
            case "upgrade_package":
                ...
                if (currentList != null && !currentList.isEmpty()) {
                    if (currentList.equals("site_package")) {
                        ...
                        ((Activity) mContext).startActivityForResult(intent, ConstantVariables.UPGRADE_PACKAGE_CODE);
                        ((Activity) mContext).overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                    }
                } else {
                    intent = new Intent(mContext, SelectPackage.class);
            ...
            case "create":
                ...
                intent.putExtra(ConstantVariables.CREATE_URL, mRedirectUrl);
                intent.putExtra(ConstantVariables.EXTRA_MODULE_TYPE, mCurrentSelectedModule);
                intent.putExtra(ConstantVariables.KEY_TOOLBAR_TITLE, mMenuJsonObject.optString("dialogueTitle", mContext.getResources().getString(R.string.item_create)));
                intent.putExtra(ConstantVariables.KEY_SUCCESS_MESSAGE, mMenuJsonObject.optString("successMessage", mContext.getResources().getString(R.string.item_created_successfully)));
                intent.putExtra(ConstantVariables.KEY_PACKAGE_NAME, ConstantVariables.APPLICATION_PACKAGE_NAME + mMenuJsonObject.optString("module", "sitecrowdfunding") + ".utils.CoreUtil");
                intent.putExtra(ConstantVariables.KEY_METHOD_NAME, "getCreatedPageIntent");
            ...
            case "user_profile_report":
                ...
                intent.putExtra(ConstantVariables.URL_STRING, mRedirectUrl);
                if (mCurrentSelectedModule.equals(ConstantVariables.STORY_MENU_TITLE)) {
                    ((Activity) mContext).startActivityForResult(intent, ConstantVariables.VIEW_PAGE_CODE);
                } else {
                    mContext.startActivity(intent);
                }
...
//                break;
            ...
            case "comment_edit":
                if (mOnMenuClickResponseListener != null) {
                    mOnMenuClickResponseListener.onItemActionSuccess(mPosition, null, mMenuName);
                }
                break;
