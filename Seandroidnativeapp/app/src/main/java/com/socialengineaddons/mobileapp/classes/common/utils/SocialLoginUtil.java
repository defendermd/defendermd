...
public class SocialLoginUtil {
    ...
    public static void putFacebookBundleParams(String gender, String timezone, String firstName, String lastName,
        ...
        FACEBOOK_TWITTER_BUNDLE.putString("email", email);
    }
                            ...
                            GraphRequest graphRequest = GraphRequest.newMeRequest(AccessToken.getCurrentAccessToken(), new GraphRequest.GraphJSONObjectCallback() {
                                ...
                                public void onCompleted(JSONObject object, GraphResponse response) {
                                    if (object != null) {
                                        ...
                                        putFacebookBundleParams(gender, timezone, firstName, lastName, imageUrl, email);
    ...
    public static void performActionOnSocialLogin(final Context context, final AppConstant appConstant,
        ...
        appConstant.postJsonResponseForUrl(loginUrl, params, new OnResponseListener() {
            ...
            public void onTaskCompleted(JSONObject jsonObject)  {
                appConstant.hideProgressDialog();
                JSONObject quickSignUp = PreferencesUtils.getModuleSettings(context, "sitequicksignup");
                ...
                if (isIntegrationRequest && mOnSocialLoginSuccessListener != null) {
                    ...
                    if (jsonObject.optString("body") != null && !jsonObject.optString("body").isEmpty()) {
                        ...
                        PreferencesUtils.setChannelizeAccessToken(context,
                                jsonObject.optString(ConstantVariables.CHANNELIZE_ACCESS_TOKEN));

                        // Login to prime Messenger on Facebook/Twitter Login
                        if (userDetail != null) {
                            MessageCoreUtils.login(userDetail.optString("user_id"),
                                    PreferencesUtils.getChannelizeAccessToken(context));
                        }
                    ...
                    } else if (quickSignUp != null && quickSignUp.optBoolean("isQuickSignUp", false)) {
                        Intent loginIntent = new Intent(context, QuickSignUpActivity.class);
                        Bundle bundle = new Bundle();
                        if (loginType.equals("facebook")) {
