...
public class UrlUtil {
    ...
    public static final String SITE_TAG_CHECK_IN_URL = AppConstant.DEFAULT_URL + "sitetagcheckin/checkin-count?";
    public static final String SITE_TAG_CHECK_IN_MENU_URL = AppConstant.DEFAULT_URL + "sitetagcheckin/content-checkin?";
    ...
    //nested comment url
    public static final String AAF_REPLY_URL = AppConstant.DEFAULT_URL + "advancedcomments/reply?";

    //Contact Information url
    public static final String ITEM_LIKE_URL = AppConstant.DEFAULT_URL + "like?";
    public static final String ITEM_UNLIKE_URL = AppConstant.DEFAULT_URL + "unlike?";

    //Crowdfunding API URLs
    public static final String CROWD_FUNDING_CATEGORY_URL = AppConstant.DEFAULT_URL + "crowdfunding/category?";
    public static final String CROWD_FUNDING_PROJECT_BROWSE_URL = AppConstant.DEFAULT_URL + "crowdfunding/browse/projects?";
    public static final String CROWD_FUNDING_PROJECT_MANAGE_URL = AppConstant.DEFAULT_URL + "crowdfunding/manage?";
    public static final String CROWD_FUNDING_FAQ_BACKER_BROWSE_URL = AppConstant.DEFAULT_URL + "crowdfunding/backer-faq?";
    public static final String CROWD_FUNDING_FAQ_OWNER_BROWSE_URL = AppConstant.DEFAULT_URL + "crowdfunding/project-owner-faq?";
    public static final String CROWD_FUNDING_PROJECT_FAVOURITE_URL = AppConstant.DEFAULT_URL + "crowdfunding/favourite/";
    public static final String CROWD_FUNDING_PROJECT_CREATE_URL = AppConstant.DEFAULT_URL + "crowdfunding/create";
    public static final String CROWD_FUNDING_PROJECT_EDIT_URL = AppConstant.DEFAULT_URL + "crowdfunding/edit";
    public static final String CROWD_FUNDING_PACKAGE_URL = AppConstant.DEFAULT_URL + "crowdfunding/packages?";
    public static final String CROWD_FUNDING_REWARD_BROWSE_URL = AppConstant.DEFAULT_URL + "crowdfunding/reward/manage/";
    public static final String CROWD_FUNDING_REWARD_SELECT_URL = AppConstant.DEFAULT_URL + "crowdfunding/backer/reward-selection/";
    public static final String CROWD_FUNDING_REWARD_CREATE_URL = AppConstant.DEFAULT_URL + "crowdfunding/reward/create/";
    public static final String CROWD_FUNDING_CHECKOUT_URL = AppConstant.DEFAULT_URL + "crowdfunding/backer/checkout/";
    public static final String CROWD_FUNDING_PLACE_ORDER_URL = AppConstant.DEFAULT_URL + "crowdfunding/backer/place-order/";
    public static final String CROWD_FUNDING_PROJECT_VIEW_URL = AppConstant.DEFAULT_URL + "crowdfunding/view/";
    public static final String CROWD_FUNDING_PROJECT_SEARCH_FORM_URL = AppConstant.DEFAULT_URL + "crowdfunding/search-form?";
    public static final String CROWD_FUNDING_PROJECT_ADD_BIO_URL = AppConstant.DEFAULT_URL + "crowdfunding/profiletab/about-you/";
    public static final String CROWD_FUNDING_PROJECT_UPLOAD_PHOTO_URL = AppConstant.DEFAULT_URL + "crowdfunding/profiletab/upload-photo/";
    public static final String CROWD_FUNDING_ADD_LEADER_URL = AppConstant.DEFAULT_URL + "crowdfunding/leader/add-leader/";
    public static final String CROWD_FUNDING_SUGGEST_LEADER_URL = AppConstant.DEFAULT_URL + "crowdfunding/leader/leader-auto-suggest/";
    public static final String CROWD_FUNDING_MANAGE_LEADER_URL = AppConstant.DEFAULT_URL + "crowdfunding/leader/manage-leaders/";
    public static final String CROWD_FUNDING_REMOVE_LEADER_URL = AppConstant.DEFAULT_URL + "crowdfunding/leader/remove/";
    public static final String CROWD_FUNDING_PAYMENT_METHOD_CONFIG_URL = AppConstant.DEFAULT_URL + "crowdfunding/set-project-gateway-info/";
    ...
    public static final String CHECK_REQUIRED_FIELD = AppConstant.DEFAULT_URL + "user/check-required-fields/";
    public static final String EDIT_MEMBER_PROFILE = AppConstant.DEFAULT_URL + "members/edit/profile/";

    // Story url
    public static final String MUTE_UNMUTE_STORY_URL = AppConstant.DEFAULT_URL + "advancedactivity/story/mute-story/";

    // Album View privacy url
    public static final String ALBUM_PRIVACY_URL = AppConstant.DEFAULT_URL + "albums/change-privacy/";

    public static final String IP_INFO_URL = "http://ip-api.com/json";
    // URL for getting path prefixes of host for deep linking
    public static final String HOST_PATH_PREFIXES_URL = AppConstant.DEFAULT_URL + "deep-linking?";
}
