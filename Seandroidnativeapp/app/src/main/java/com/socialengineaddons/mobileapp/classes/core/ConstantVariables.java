...
public class ConstantVariables {
    ...
    * */
    ...
    public static final int ENABLE_RATE_US_POPUP = 1;
    public static final int FORM_LAYOUT_TYPE = 1;
    public static final int ENABLE_CROWDFUNDING = 0;
    public static final int ENABLE_PIP = 0;
    ...
    public static final int PERMISSION_RECORD_AUDIO = 192;
    public static final int RECEIVE_SMS = 182;
    ...
    public static final int VIEW_NESTED_REPLIES_PAGE = 47;
    public static final int VIEW_EDIT_COMMENT_PAGE = 46;
    public static final int VIEW_EDIT_NESTED_COMMENT_PAGE = 43;
    public static final int VIEW_DELETE_NESTED_REPLIES_PAGE = 44;
    public static final int VIEW_lIKE_NESTED_REPLIES_PAGE = 45;
    ...
    public static final int AUTO_PLAY_VIDEO_VIEW_CODE = 700;
    ...
    public static final int PHOTO_UPLOAD_CODE = 112;
    public static final int LIVE_VIDEO_REQUEST_CODE = 67;

    //Request code for fragment loading in twitter
    public static final int TWITTER_REQUEST_CODE = 140;

    public static final int FILE_UPLOAD_REQUEST = 41;
    ...
    //Nested comment Request Code
    public static final int NESTED_COMMENT_ACTIVITY_CODE = 201;

    //Edit comment Request Code
    public static final int EDIT_COMMENT_ACTIVITY_CODE = 202;
    ...
    public static final int REWARD_BROWSE_PAGE = 919;
    public static final int PROJECT_BACKED_SUCCESS_PAGE = 959;
    public static final int PROJECT_EDIT_BIO_REQUEST_CODE = 959;
    public static final int PIP_MODE_REQUEST_CODE = 960;
    ...
    public final static int REFRESH_UNREAD_MESSAGES_TIME = 10000;
    ...
    public static final String VIDEO_OVERLAY_IMAGE = "video_overlay_image";
    public static final String STORY_DURATION = "story_duration";
    public static final String STORY_MENU_TITLE = "story_menu_title";
    public static final String MULTI_CURRENCY = "sitemulticurrency";
    public static final String SITE_MULTI_CURRENCY = "core_main_multicurrency";
    ...
    public static final String FRIENDS_MENU_TITLE = "core_main_friends";

    public static final String SITE_LIVE_STREAMING_TYPE = "sitetagcheckin_live_video_post_self";
    ...
    public static final String ADV_SITE_VIDEO_TITLE = "sitevideo_video";
    ...
    public static final String SITE_STORE_PRODUCT_MENU = "sitestoreproduct";
    ...
    public static final String IS_ALBUM_VIEW = "isAlbumView";
    ...
    public static final String SHOW_SEND_MESSAGE_BUTTON = "showSendMessageButton";
    public static final String COMMENT_TYPE = "commentType";
    public static final String AAF_COMMENT = "aaf_comment";
    ...
    public static final String SEND_MESSAGE_IN_MESSENGER = "send_message_in_messenger";

    //Activity feed post length
    public static final int FEED_TITLE_BODY_LENGTH = 300;

    // Album description lenght
    public static final int ALBUM_DESCRIPTION_LENGTH = 150;
    ...
    public static final String STORY_PLUGIN_DISABLED = "story_disabled";
    ...
    */
     ...
     */
    public static final int ENABLE_ADMOB = 2;
    ...
    public static final String CROWD_FUNDING_MAIN_TITLE = "crowd_funding_main";
    public static final String CROWD_FUNDING_MODULE_NAME = "sitecrowdfunding";
    public static final String CROWD_FUNDING_PROJECT_SUBJECT_TYPE = "sitecrowdfunding_project";
    public static final String ICON_TAG = "tag";
    public static final String ICON_CHECK_IN = "checkin";
    public static final String ICON_MAP_MARKER = "marker";
    public static final String ICON_EMPTY_HEART = "empty_heart";
    public static final String ICON_SOLID_HEART = "solid_heart";
    public static final String ICON_EMPTY_THUMBS_UP = "empty_thumbs_up";
    public static final String KEY_SUCCESS_MESSAGE = "success_message";
    public static final String KEY_DEFAULT_MESSAGE = "success_message";
    ...
    public static final String KEY_CONTENT_ID_NAME = "project_id";
    public static final String KEY_PSEUDO_NAME = "pseudo_name";
    public static final String KEY_PAYMENT_REQUEST = "payment_request";
    ...
    public static final String SEARCH_METHOD_NAME = "setSearchFragment";
    ...
    public static final String APPLICATION_PACKAGE_NAME =AppConstant.APPLICATION_PACKAGE_NAME + ".classes.modules.";
    public static final String CONTENT_URL = "content_url";
    public static final String SCHEMA_KEY_SEND_INVITES = "send_invites";
    public static final String METHOD_VIEW_PAGE_INTENT = "getViewPageIntent";
    ...
    public static final String KEY_PROJECT_BACKED_SUCCESS = "KEY_PROJECT_BACKED_SUCCESS";
    ...
    public static final String KEY_LEFT_DRAWABLE = "leftDrawable";
    public static final String KEY_RIGHT_DRAWABLE = "rightDrawable";

    //Customization
    public static final int CANCEL_FILL_REQUIRED_FIELD = 786;
    public static final int CANCELED_QR_SCAN = 787;
    public static final int QR_SCANNER_REQUEST_CODE = 49374;
    public static final String FILL_REQUIRED_FIELD = "fillRequiredField";

    public static final String FRAGMENT_ITEM_POSITION = "FRAGMENT_ITEM_POSITION";
    public static final String SET_NESTED_SCROLLING_ENABLED = "SET_NESTED_SCROLLING_ENABLED";
    public static final String KEY_CREATE_NEW_ALBUM = "KEY_CREATE_NEW_ALBUM";
    ...
    public static final String IS_LIVE_STREAM_SHARED_ON_FEED = "is_live_stream_shared_on_feed";
    public static final String LIVE_STREAM_TYPE = "live_streaming";
    public static final String LIVE_STREAM_VIEWERS_LIST = "live_stream_viewers";
    public static final String IS_LIVE_STREAM_VIEWER = "is_live_stream_viewer";
    public static final String LIVE_STREAM_VIEWERS_COUNT = "live_stream_viewers_count";
    public static final String STREAM_NOT_EXIST = "stream_not_exist";
    public static final String LIVE_STREAM_REACTIONS = "live_stream_reactions";
    public static final String IS_SHOW_ADDED_LOCATION = "is_show_added_location";
    public static final String IS_CURRENCY_UPDATED = "is_currency_changed";
    public static final String CHANNELIZE_ACCESS_TOKEN = "chAccessTokenv2";

    // These values get replaced using automation process

    //This will be the default API calling url.
    static final String API_DEFAULT_URL = "https://api_server_url.primemessenger.com/api/";

    //This will be the mqtt client server url.
    static final String MQTT_SERVER_URL = "wss://mqtt_server_url.primemessenger.com/mqtt";

    // This will be the api key.
    public static final String API_KEY = "kuK4bj8GTqB6MiLY";

    // this will be sender id of the project
    public static final String FIREBASE_SENDER_ID = "361411816178";

    // This will be the mobilesdk_app_id in google-services.json file
    public static final String FIREBASE_APPLICATION_ID = "1:361411816178:android:52a6079ee07a65b5";

    // This will be the giphy api key.
    static final String GIPHY_API_KEY = "";

    // This will be the google places api key.
    static final String GOOGLE_PLACES_API_KEY = "";
