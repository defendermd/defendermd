...
public class DrawerItem {
    ...
    public DrawerItem(String headerTitle, String itemName, String itemRegName, String badgeCount, int canCreate,
                      int packagesEnabled, String icon, String iconColor, boolean canView, JSONObject otherInfo){
        super();
    ...
    public DrawerItem(String headerTitle, String title) {
        this(headerTitle, null, null, null, 0, 0, null, null, true, null);
        this.title = title;
    }
