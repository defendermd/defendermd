...
public class HomeScreen extends FragmentActivity implements View.OnClickListener, SocialLoginUtil.OnSocialLoginSuccessListener {
    ...
    private JSONObject joSignUpForm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout relativeLayout  = findViewById(R.id.social_login_button);
        ...
        if (!getResources().getString(R.string.facebook_app_id).isEmpty()) {
            ...
            layoutParams.setMargins(padding10,0, padding10, 0);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
                layoutParams.setMarginStart(padding10);
                layoutParams.setMarginEnd(padding10);
            }

            facebookLoginButton.setLayoutParams(layoutParams);
            facebookLoginButton.setPadding(padding10, padding10, padding10, padding10);
            facebookLoginButton.setPaddingRelative(padding10, padding10, padding10, padding10);
    ...
    private void setBrowseGuestAndLanguageOptions() {
        ...
        if (!mIsBrowseGuestEnabled && !mIsMultiLanguageEnabled) {
            ...
            int padding10 = (int) getResources().getDimension(R.dimen.login_button_top_bottom_padding);
            layoutParams.setMargins(0, padding10, 0, 0);
            mainButtons.setLayoutParams(layoutParams);
            mainButtons.setPadding(0, (int) getResources().getDimension(R.dimen.login_button_top_bottom_padding), 0,
                    (int) getResources().getDimension(R.dimen.login_button_top_bottom_padding));
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
                mainButtons.setPaddingRelative(0, (int) getResources().getDimension(R.dimen.login_button_top_bottom_padding), 0,
                        (int) getResources().getDimension(R.dimen.login_button_top_bottom_padding));
            }
        }
    }
    ...
    public void onClick(View v) {
        ...
        switch (id){
            ...
            case R.id.signup_button:
                JSONObject quickSignUp = PreferencesUtils.getModuleSettings(HomeScreen.this, "sitequicksignup");
                Intent signUpIntent;
                if (quickSignUp != null && quickSignUp.optBoolean("isQuickSignUp", false)) {
                    signUpIntent = new Intent(HomeScreen.this, QuickSignUpActivity.class);
                    if (joSignUpForm != null) {
                        signUpIntent.putExtra("signUpForm", joSignUpForm.toString());
                    }
                } else {
                    signUpIntent = new Intent(HomeScreen.this, SubscriptionActivity.class);
                }
