...
package com.socialengineaddons.mobileapp.classes.core.startscreens;
...
public class NewHomeScreen extends FragmentActivity implements View.OnClickListener {
    ...
    private ImageView[] ivSlideIcon = new ImageView[7];
    ...
    ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (position > currentPos) {
                ivSlideIcon[position].setImageDrawable(null);
                animateSlideIcon(position);
            } else if (position >= 0) {
                ivSlideIcon[position].setImageDrawable(drawable[position]);
            }
            currentPos = position;
...
//                btnNext.setText("");
    ...
    private void setButtonColors(int position) {
        ...
        int padding15 = (int) mContext.getResources().getDimension(R.dimen.padding_15dp);
        btnNext.setTextColor(ContextCompat.getColor(mContext, textColor));
        btnSkip.setTextColor(ContextCompat.getColor(mContext, textColor));
        btnNext.setTypeface(GlobalFunctions.getFontIconTypeFace(mContext));
        btnNext.setText("\u203A");
        btnNext.setTextSize(25);
        btnNext.setTypeface(btnNext.getTypeface(), Typeface.BOLD);
        btnNext.setPadding(padding15, padding15, padding15, padding15);
//        U+0003E

    }

    private void setSlideIconAnimation(int position) {
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                ivSlideIcon[position].setImageDrawable(null);
                Animation animRight = AnimationUtils.loadAnimation(mContext, R.anim.slideshow_icon_from_right);
                animRight.setDuration(400);
                ivSlideIcon[position].startAnimation(animRight);
                ivSlideIcon[position].setImageDrawable(drawable[position]);
            }
        }, 200);
    }

    private void animateSlideIcon(int position) {
        ivSlideIcon[position].setImageDrawable(null);
        Animation animRight = AnimationUtils.loadAnimation(mContext, R.anim.slideshow_icon_from_right);
        ivSlideIcon[position].startAnimation(animRight);
        ivSlideIcon[position].setImageDrawable(drawable[position]);
    ...
    public class MyViewPagerAdapter extends android.support.v4.view.PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            ivSlideIcon[position] = view.findViewById(R.id.slide_icon);
            ...
            switch (position) {
                case 0:
                    ...
                    drawable[position] = ContextCompat.getDrawable(mContext, R.drawable.slide_screen_1);
                ...
                case 1:
                    ...
                    drawable[position] = ContextCompat.getDrawable(mContext, R.drawable.slide_screen_2);
                ...
                case 2:
                    ...
                    drawable[position] = ContextCompat.getDrawable(mContext, R.drawable.slide_screen_3);
                ...
                case 3:
                    ...
                    drawable[position] = ContextCompat.getDrawable(mContext, R.drawable.slide_screen_4);
                ...
                case 4:
                    ...
                    drawable[position] = ContextCompat.getDrawable(mContext, R.drawable.slide_screen_5);
                ...
                case 5:
                    ...
                    drawable[position] = ContextCompat.getDrawable(mContext, R.drawable.slide_screen_6);
                ...
                case 6:
                    ...
                    drawable[position] = ContextCompat.getDrawable(mContext, R.drawable.slide_screen_7);
