    ...
    public void onBindViewHolder(final ItemViewHolder holder, final int position) {
        ...
        if (!mPhotoDetail.isLiked()) {
            ...
            holder.tvLikeButton.setCompoundDrawablesWithIntrinsicBounds(
                    ContextCompat.getDrawable(mContext, R.drawable.ic_like_chat), null, null, null);
        ...
        //show like count
        if (mPhotoDetail.getImageLikeCount() != 0) {
            holder.tvLikeButton.setText(Integer.toString(mPhotoDetail.getImageLikeCount()));
        } else {
            holder.tvLikeButton.setText("");
        }

        //show comment count
        if (mPhotoDetail.getImageCommentCount() != 0 ) {
            holder.tvCommentButton.setText(Html.fromHtml(String.format(
                    mContext.getResources().getString(R.string.comment_count_text),
                    mPhotoDetail.getImageCommentCount(), "" )));
        } else {
            holder.tvCommentButton.setText("");
        }
                        ...
                        reactionsAdapter = new ImageAdapter((Activity) mContext, reactionsImages, true,
                                new OnItemClickListener() {
                                    ...
                                    public void onItemClick(View view, int position) {
                                        ...
                                        holder.ivReactionIcon.startAnimation(zoomInAnimation);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.like_view:
                 ...
                 */
                holder.tvLikeButton.startAnimation(AppConstant.getZoomInAnimation(mContext));
                holder.ivReactionIcon.startAnimation(AppConstant.getZoomInAnimation(mContext));
                holder.ivReactionIcon.setAnimation(null);
