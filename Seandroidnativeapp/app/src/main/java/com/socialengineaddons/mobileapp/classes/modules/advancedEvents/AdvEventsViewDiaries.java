...
public class AdvEventsViewDiaries extends AppCompatActivity implements View.OnClickListener,
    ...
    private int diaryId, eventCount, ownerId;
    ...
    public void addDataToList(JSONObject jsonObject){
        ...
        if (mBody != null) {
            try {
                ...
                ownerId = resObj.optInt("owner_id");
                ...
                mBrowseListItems.setUserId(resObj.optInt("owner_id"));
                mBrowseListItems.setUserDisplayName(resObj.optString("owner_title"));
                mBrowseListItems.setUserProfileImageUrl(resObj.optString("owner_image_normal"));
                ...
                if (mTotalItemCount != 0){
                    ...
                    for (int i = 0; i < mDataResponse.length(); i++) {
                        ...
                        mBrowseItemList.add(new BrowseListItems(image_icon, hostImage, title,
                                ...
                                starttime, hostId, hostType, hasMultipleDates,0,0, null, occurrence_id));
