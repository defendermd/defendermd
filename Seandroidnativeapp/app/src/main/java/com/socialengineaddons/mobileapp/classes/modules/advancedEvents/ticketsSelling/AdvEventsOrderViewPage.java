...
package com.socialengineaddons.mobileapp.classes.modules.advancedEvents.ticketsSelling;
...
import com.socialengineaddons.mobileapp.classes.modules.advancedEvents.AdvEventsBrowseDataAdapter;
...
public class AdvEventsOrderViewPage extends AppCompatActivity implements View.OnClickListener {
    ...
    private void loadDataInView(JSONObject mBody) {
        ...
        mTaxAmountTextView.setText(": " + CurrencyUtils.getCurrencyConvertedValue(mContext, currency, taxAmount));
        ...
        mSubtotalTextView.setText(CurrencyUtils.getCurrencyConvertedValue(mContext, currency, subTotal));
        mTaxText.setText(getResources().getString(R.string.tax_text));
        mTaxTextView.setText(CurrencyUtils.getCurrencyConvertedValue(mContext, currency, taxAmount));
        mGrandTotalTextView.setText(CurrencyUtils.getCurrencyConvertedValue(mContext, currency, grandTotal));
