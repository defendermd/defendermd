 ...
 */
public class AdvGroupsBrowseFragment extends BaseFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBrowseDataAdapter = new BrowseDataAdapter(getActivity(), R.layout.adv_group_item_view, mBrowseItemList);
                ...
                if (mDataResponse != null && mDataResponse.length() > 0) {
                    ...
                    for (int i = 0; i < mDataResponse.length(); i++) {
                        ...
                        mBrowseItemList.add(new BrowseListItems(image_icon, title,
                                    owner_title, group_id, (allow_to_view == 1), like_count, member_count,
                                    featured, sponsored, closed, description));
