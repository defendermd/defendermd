 ...
 */
public class AdvGroupsManageFragment extends BaseFragment implements AdapterView.OnItemClickListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mManageDataAdapter = new ManageDataAdapter(getActivity(), R.layout.adv_group_item_view, mBrowseItemList,
            ...
            try {
                ...
                if (mDataResponse != null && mDataResponse.length() > 0) {
                    ...
                    for (int i = 0; i < mDataResponse.length(); i++) {
                        ...
                        String description = jsonDataObject.optString("body");
                        mBrowseItemList.add(new BrowseListItems(image_icon, title,
                                owner_title, like_count, member_count, group_id,
                                jsonDataObject.optJSONArray("menu"), closed, description));
                    }
                } else {
