...
public class AdvGroupsProfile extends AppCompatActivity implements View.OnClickListener,
    ...
    private boolean showAddPeople = true, isGroupPublished = false, fromQRScanner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fromQRScanner = getIntent().getBooleanExtra("isQRScanner", false);
    ...
    private void loadViewPageData(JSONObject bodyJsonObject) {
        ...
        if (bodyJsonObject != null && bodyJsonObject.length() != 0) {
            try {
                ...
                mBrowseList.setUserId(responseObject.optInt("owner_id"));
                mBrowseList.setUserDisplayName(responseObject.optString("owner_title"));
                mBrowseList.setUserProfileImageUrl(responseObject.optString("owner_image_normal"));
    ...
    public void onBackPressed() {
        if (!isFinishing()) {
            ...
            //overriding setResult in case of QR scanner fragment
            if(fromQRScanner) {
