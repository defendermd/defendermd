 ...
 */
public class AdvVideoBrowseFragment extends BaseFragment implements  AdapterView.OnItemClickListener,
        ...
        if (listItems != null) {
            ...
            if (!isAllowedToView) {
                ...
                if (listItems.getmVideoType() >=1 && listItems.getmVideoType() <= 6) {
                    ...
                    mainIntent.putExtra(ConstantVariables.ADV_VIDEO_INTEGRATED, 1);
