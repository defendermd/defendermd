 ...
 */
public class AdvVideoManageFragment extends BaseFragment implements AdapterView.OnItemClickListener,
    ...
    private String mManageVideoUrl, mOrderBy = "";
    ...
    public static AdvVideoManageFragment newInstance(Bundle bundle) {
        // Required public constructor
        AdvVideoManageFragment fragment = new AdvVideoManageFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mManageVideoUrl = UrlUtil.ADV_VIDEO_MANAGE_URL;
        ...
        mManageDataAdapter = new ManageDataAdapter(mContext, R.layout.album_item_view, mBrowseItemList,
                null, AdvVideoManageFragment.this);
    ...
    private void getViews() {
        ...
        adapter.add(mContext.getResources().getString(R.string.liked_videos_filter));
        adapter.add(mContext.getResources().getString(R.string.favourite_videos_filter));
        adapter.add(mContext.getResources().getString(R.string.watch_later_videos_filter));
     ...
     */
    private String getVideoManageUrl() {
    ...
    private void makeRequest() {
        ...
        mAppConst.getJsonResponseFromUrl(getVideoManageUrl(), new OnResponseListener() {
            @Override
        ...
        if (mDataResponse != null && mDataResponse.length() > 0) {
            ...
            for (int i = 0; i < mDataResponse.length(); i++) {
                ...
                mBrowseItemList.add(new BrowseListItems(image, title, createdDate,
                        ...
                        duration, video_id, event_id, video_url, contentUrl, type, mMenuArray, videoOverlayObject));
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (listItems != null) {
            Intent mainIntent;
            if (listItems.getmVideoType() >=1 && listItems.getmVideoType() <= 6) {
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        ...
        if (limit == totalItemCount && !isLoading) {
            ...
            if (limit >= AppConstant.LIMIT && (AppConstant.LIMIT * mLoadingPageNo) < mBrowseList.getmTotalItemCount()) {
                ...
                isLoading = true;
                loadMoreData(getVideoManageUrl());
            }
