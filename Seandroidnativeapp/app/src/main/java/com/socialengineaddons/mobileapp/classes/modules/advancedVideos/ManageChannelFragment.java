 ...
 */
public class ManageChannelFragment extends BaseFragment implements AdapterView.OnItemClickListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mManageDataAdapter = new ManageDataAdapter(mContext, R.layout.album_item_view, mBrowseItemList,
                ConstantVariables.ADV_VIDEO_CHANNEL_MENU_TITLE, ManageChannelFragment.this);
