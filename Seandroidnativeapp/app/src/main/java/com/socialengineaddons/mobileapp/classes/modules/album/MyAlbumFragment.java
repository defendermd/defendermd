 ...
 */
public class MyAlbumFragment extends BaseFragment implements  SwipeRefreshLayout.OnRefreshListener,
    ...
    private boolean isVisibleToUser = false, isLoading = false, isAdLoaded = false, isCommunityAds = false, canCreate = true;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
            ...
            public int getSpanSize(int position) {
                if (mManageDataAdapter.getItemViewType(position) == 0) {
                    return 2;
                } else {
                    return 1;
                }
        ...
        mManageDataAdapter = new RecyclerViewAdapter(mContext, mBrowseItemList, false,  0,
                ...
                new OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        } else if (position < mBrowseItemList.size()) {
