...
package com.socialengineaddons.mobileapp.classes.modules.forum;
...
public class ForumView extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,
        AbsListView.OnScrollListener, OnOptionItemClickResponseListener, DeepLinksHandler {
    ...
    */
    ...
    public void handleAppLinks() {
        ...
        if (viewUrl != null && data != null) {
            try {
                String subjectId = data.getPath().replace("/forums", "");
                viewUrl = AppConstant.DEFAULT_URL + "/forums/topic" + subjectId;
