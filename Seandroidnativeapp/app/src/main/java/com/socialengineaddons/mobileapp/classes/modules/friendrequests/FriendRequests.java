...
package com.socialengineaddons.mobileapp.classes.modules.friendrequests;
...
public class FriendRequests extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
                                    ...
                                    new OnResponseListener() {
                                        ...
                                        public void onTaskCompleted(JSONObject jsonObject) throws JSONException {
                                            ...
                                            if (mBrowseItemList.size() == 0) {
                                                displayNoContentErrorMessage();
                                            }

                                            Toast.makeText(mContext, mContext.getResources().getString(R.string.you_are_now_friends_text), Toast.LENGTH_SHORT).show();
                                        }
    ...
    private void displayNoContentErrorMessage() {
    ...
    public void onAttach(Context context) {
        ...
        mContext = context;if(mRecyclerView != null){
