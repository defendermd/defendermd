...
package com.socialengineaddons.mobileapp.classes.modules.globalSearch;
...
import com.socialengineaddons.mobileapp.classes.common.adapters.GlobalSearchAdapter;
...
public class GlobalSearchFragment extends Fragment implements AdapterView.OnItemClickListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(getArguments() != null){
            ...
            searchArgumentSet.remove(ConstantVariables.IS_SEARCH_MODE);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        if(type.equals("user")){
            ...
            if (viewIntent == null) {
                ...
                bundle.putString(ConstantVariables.CONTENT_ID, String.valueOf(id));
                Object intent = GlobalFunctions.invokeMethod(ConstantVariables.APPLICATION_PACKAGE_NAME + type + ".utils.CoreUtil", ConstantVariables.METHOD_VIEW_PAGE_INTENT, bundle);
                viewIntent = (intent != null && intent instanceof Intent) ? (Intent) intent : viewIntent;
            }
            if(viewIntent != null){
                switch (type) {
