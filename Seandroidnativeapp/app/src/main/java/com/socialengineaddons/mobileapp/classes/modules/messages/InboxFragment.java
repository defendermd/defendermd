...
public class InboxFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private int pageNumber = 1, mLoadingPageNo = 1;
    ...
    private int mInboxRead, mInboxDeleted, mMessageId, mConversationId, mTotalMessageCount;
                    ...
                    public void onItemClick(View view, int position) {
                         ...
                         */
                            if(listItems.getInboxRead() == 0){
                                ...
                                mAppConst.postJsonRequest(UrlUtil.MESSAGE_READ_URL, postParams);
                            }
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if(limit == totalItemCount && !isLoading) {
                    ...
                    if(limit >= AppConstant.LIMIT && (AppConstant.LIMIT * mLoadingPageNo)  <
                        ...
                        String url = UrlUtil.MESSAGE_INBOX_URL + "&page=" + mLoadingPageNo;
                        isLoading = true;
                        loadMoreData(url);
                    }
                }
