...
public class MessageViewActivity extends AppCompatActivity implements View.OnClickListener, TextWatcher,
    ...
    public void setDataInAdapter(JSONObject jsonObject) {
        ...
        try {
            ...
            // Disable message typing if user don't have permission to message
            if (mConversationObject.optInt("isSendMessage") == 0) {
                inputMsg.setOnClickListener(this);
                inputMsg.setFocusable(false);
            }
            ...
            for (int i = 0; i < messagesArray.length(); i++) {
                ...
                if (mMessageBody.contains("sitestories_story")) {
                ...
                if (mAttachmentData != null) {
                    ...
                    if (mAttachmentType.equals("album_photo")) {
                        ...
                        photoListDetails = new PhotoListDetails(albumId, photoId, mAttachmentImage, photoListUrl,
        ...
        alertDialogPositiveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!linkText.isEmpty() && GlobalFunctions.isValidUrl(linkText)) {
                    ...
                    new UploadFileToServerUtils(MessageViewActivity.this, mAttachUrl, uriText, mAttachType).execute();
            ...
            case ConstantVariables.REQUEST_MUSIC:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (selectedMusicUri != null) {
                        ...
                        new UploadFileToServerUtils(MessageViewActivity.this, mAttachUrl, mSelectedMusicFile).execute();
            ...
            case R.id.btnSend:
                try {
                    if (inputMsg.getText().length() > 0 && inputMsg.getText() != null && isMessageSent &&
                        ...
                        // Uploading files in background with the Message body.
                        new UploadFileToServerUtils(MessageViewActivity.this, mItemViewUrl, postParams,
                                mSelectPath).execute();
                    }
                } catch (Exception ex) {
                    ex.printStackTrace();
