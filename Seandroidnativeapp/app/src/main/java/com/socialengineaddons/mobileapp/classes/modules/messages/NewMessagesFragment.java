...
public class NewMessagesFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public void makeRequest(){
        ...
        mAppConst.getJsonResponseFromUrl(mInboxRequestUrl, new OnResponseListener() {
            ...
            public void onErrorInExecutingTask(String message, boolean isRetryOption) {
                ...
                View parentView = ((Activity) mContext).findViewById(android.R.id.content);
                if (isRetryOption) {
                    snackbar = SnackbarUtils.displaySnackbarWithAction(getActivity(), parentView, message,
                    ...
                    SnackbarUtils.displaySnackbar(parentView, message);
                }
            }
        });
    ...
    private void addDataToBrowseList(JSONObject jsonObject) {
        mBody = jsonObject;
