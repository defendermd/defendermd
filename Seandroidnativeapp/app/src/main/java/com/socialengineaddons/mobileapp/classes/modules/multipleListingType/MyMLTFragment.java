...
public class MyMLTFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mMLTBrowseType == 4) {
            mMLTBrowseType = PreferencesUtils.getCurrentSelectedListingSecondaryBrowseType(mContext, mListingTypeId);
        }
