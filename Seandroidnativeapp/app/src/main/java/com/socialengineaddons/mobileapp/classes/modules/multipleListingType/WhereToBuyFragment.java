...
import com.socialengineaddons.mobileapp.classes.common.adapters.WhereToBuyAdapter;
            ...
            if(priceInfoArray != null && priceInfoArray.length() != 0){
                ...
                for(int i = 0; i < priceInfoArray.length(); i++){
                    ...
                    if(priceObject.optDouble("price") != 0){
                        price = CurrencyUtils.getCurrencyConvertedValue(mContext, mCurrency, priceObject.optDouble("price"));
                    } else {
