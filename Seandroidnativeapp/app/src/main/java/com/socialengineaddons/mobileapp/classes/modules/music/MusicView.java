...
import com.socialengineaddons.mobileapp.classes.modules.music.adapter.TracksAdapter;
import com.socialengineaddons.mobileapp.classes.modules.music.controls.Controls;
import com.socialengineaddons.mobileapp.classes.modules.music.service.SongService;
import com.socialengineaddons.mobileapp.classes.modules.music.ui.ArtistView;
import com.socialengineaddons.mobileapp.classes.modules.music.ui.TrackView;
...
public class MusicView extends AppCompatActivity implements TracksAdapter.Listener, AppBarLayout.OnOffsetChangedListener, OnOptionItemClickResponseListener {
    ...
    private String description, owner_image, owner_title, creation_date, album_Title, album_image;
    ...
    public void setDetailsInView(){
        ...
        createAlbumImageBitmap(album_image);
    }
    ...
    public void createAlbumImageBitmap(String url) {
        if (url != null && url.length() > 0) {
            new LoadAlbumThumbAsync(url).execute();
        }
    }
    ...
    public class LoadAlbumThumbAsync extends AsyncTask<Void, String, Void> {
        ...
        public LoadAlbumThumbAsync(String albumImage) {
            this.albumPath = albumImage;
        }
        ...
        protected Void doInBackground(Void... params) {
            try {
                bitmapAlbum = BitmapUtils.getBitmapFromURL(albumPath);
            } catch (Exception e) {
                e.printStackTrace();
            }
            return null;
