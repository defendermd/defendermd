...
package com.socialengineaddons.mobileapp.classes.modules.music.utils;
...
public class UtilFunctions {
	...
	public static boolean newNotificationUISupport() {
		int sdkVersion = Build.VERSION.SDK_INT;
		return sdkVersion >= Build.VERSION_CODES.N;
	}
}
