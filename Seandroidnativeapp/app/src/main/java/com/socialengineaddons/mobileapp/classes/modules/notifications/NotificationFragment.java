...
public class NotificationFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    JSONObject mSubjectResponse, mObjectResponse, mNotificationObject;
    ...
    public void addNotificationToTheList(JSONObject jsonObject){
        mTotalUpdatedItemCount = jsonObject.optInt("recentUpdateTotalItemCount");
        ...
        if(mTotalUpdatedItemCount != 0){
            ...
            mRecentUpdatedItemArray = jsonObject.optJSONArray("recentUpdates");
            if (mRecentUpdatedItemArray != null ) {
