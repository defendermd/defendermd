...
package com.socialengineaddons.mobileapp.classes.modules.photoLightBox;
...
public class PhotoLightBoxActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    private boolean isPhotoComment = false, showOptions = true,isShareClicked = false, isAlbumView = false;
    ...
    private String fullCaption, shortCaption, mSubjectType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isAlbumView = intent.getBooleanExtra(ConstantVariables.IS_ALBUM_VIEW,false);
        ...
        if (getSubjectType().equals("album_photo") && showOptions && !mAppConst.isLoggedOutUser()) {
    ...
    public void setPageDetails(int position){
        try {
            ...
            mSubjectType = photoListDetails.getmSubjectType();
            albumTitle = photoListDetails.getAlbumTitle();
            albumId = photoListDetails.geAlbumId();
    ...
    private String getSubjectType(){
        ...
        switch(currentSelectedOption){
            case "core_main_group" :
                mSubjectType = "group_photo";
                break;

            case "core_main_event" :
                mSubjectType = "event_photo";
                break;

            case "core_main_album" :
                mSubjectType = "album_photo";
                break;

            case "core_main_classified" :
                mSubjectType = "classified_photo";
                break;
            case "core_main_siteevent":
                mSubjectType = "siteevent_photo";
                break;
            case "sitereview_listing":
            case "sitereview_wishlist":
                mSubjectType = "sitereview_photo";
                break;
            case "core_main_sitegroup":
                mSubjectType = "sitegroup_photo";
                break;
            case "core_main_sitepage":
                mSubjectType = "sitepage_photo";
                break;
            case ConstantVariables.PRODUCT_MENU_TITLE:
                mSubjectType = "sitestoreproduct_photo";
                break;
            case ConstantVariables.STORE_MENU_TITLE:
                mSubjectType = "sitestore_photo";
                break;
            case ConstantVariables.ADV_VIDEO_MENU_TITLE:
            case ConstantVariables.ADV_VIDEO_CHANNEL_MENU_TITLE:
                mSubjectType = "sitevideo_photo";
                break;
            default:
                mSubjectType = (mSubjectType == null) ? "album_photo" : mSubjectType;
        }
            ...
            if (mDataResponseArray != null) {
                for (int i = 0; i < mDataResponseArray.length(); i++) {
                    ...
                    mPhotoDetails.add(new PhotoListDetails(albumTitle, owner_title, image_title,
                            image_desc,photo_id, albumId, normalImgUrl, likeCount, commentCount, likeStatus,
                            menuArray));
                }
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            ...
            case R.id.likeButton:
                ...
                int reactionId = 0;
                String reactionIcon = null, caption = null, reactionLargeIcon = null;
                ...
                if(isReactionsEnabled && mReactionsObject != null ){
                    ...
                    reactionIcon = mReactionsObject.optJSONObject("like").optJSONObject("icon").
                            optString("reaction_image_icon");
                    reactionLargeIcon = mReactionsObject.optJSONObject("like").optJSONObject("icon").
    ...
    public boolean onLongClick(View v) {
        ...
        reactionsRecyclerView.setBackground(ContextCompat.getDrawable(mContext, R.drawable.shape));

        TextView textView = new TextView(this);
        textView.setBackground(mContext.getResources().getDrawable(R.drawable.ic_tip_down_white));
        ...
        tipLayout.setPadding((int) mContext.getResources().getDimension(R.dimen.dimen_20dp),
        ...
        if (photoListDetails.getImageLikeCount() == 0 && photoListDetails.getImageCommentCount() == 0) {
            popUp.showAtLocation(linearLayout, Gravity.TOP, location[0] - (int) mContext.getResources().getDimension(R.dimen.reaction_popup_offset_x),
                    location[1] - (int) mContext.getResources().getDimension(R.dimen.reaction_popup_lightbox_y));
        } else {
            popUp.showAtLocation(linearLayout, Gravity.TOP, location[0] - (int) mContext.getResources().getDimension(R.dimen.reaction_popup_offset_x), location[1]);
        }
        ...
        if (mReactionsObject != null && mReactionsArray != null) {
            ...
            for (int i = 0; i < mReactionsArray.size(); i++) {
                ...
                String reaction_image_url = reactionObject.optJSONObject("icon").
                        optString("reaction_image_icon");
                String reaction_image_large_url = reactionObject.optJSONObject("icon").
                        optString("reaction_image_large_icon");
                ...
                reactionsImages.add(new ImageViewList(reaction_image_url, caption,
                        reaction, reactionId, reactionIconUrl, reaction_image_large_url));
            }
    ...
    public void onOptionItemActionSuccess(Object itemList, String menuName) {
        ...
        switch (menuName) {
            ...
            case "view_album":
                Intent intent = null;
                if (isAlbumView) {
                    mRequestUrl = UrlUtil.ALBUM_VIEW_PAGE + albumId + "?gutter_menu=1";
                }
