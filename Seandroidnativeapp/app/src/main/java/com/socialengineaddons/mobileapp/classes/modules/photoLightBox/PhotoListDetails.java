...
public class PhotoListDetails implements Serializable {
    ...
    public PhotoListDetails(String albumTitle,String ownerTitle,String photoTitle,String photoDescription,
                            int photoId, int albumId, String imgUrl, int likeCount, int commentCount,
                            boolean likeStatus,String menuArray){
    ...
    //For Albums,Event and Groups
    public PhotoListDetails(String albumTitle, String ownerTitle, String photoTitle, String photoDescription,
                            int photoId, String imgUrl, int likeCount, int commentCount, boolean likeStatus, String menuArray,
                            String reactionsObject, String userTagArray, String contentUrl, String subjectType, int albumId){
    ...
    //Message view page.
    public PhotoListDetails(int albumId, int photoId,String imgUrl,String imageRequestUrl,int totalImageCount,
