...
import com.socialengineaddons.mobileapp.classes.modules.store.adapters.ProductListingAdapter;
...
import com.socialengineaddons.mobileapp.classes.modules.store.fragments.CartFragment;
import com.socialengineaddons.mobileapp.classes.modules.store.fragments.OrderReviewFragment;
import com.socialengineaddons.mobileapp.classes.modules.store.fragments.ShippingDetailFragment;
import com.socialengineaddons.mobileapp.classes.modules.store.helpers.SwipeDismissHelper;
...
public class CartView extends FormActivity implements CartFragment.CartFragmentActionListener,
    ...
    public void createViewForBottomSheet(JSONObject jsonObject, final LinearLayout view_block,
        ...
        for (int i = 0; i < formArray.length() - 1; i++) {
            ...
            if (shippingInformation != null && !shippingInformation.isEmpty()) {
                /* Display shipping charge in formatted currency */
                shippingInformation += " " + CurrencyUtils.getCurrencyConvertedValue(mContext, currency, elementObject.optDouble("shippingCharge"));
    ...
    public void updateCart() {
        if (mProductInfoList.size() == 0) {
            ...
            Log.v("cartLogs", "cart not Empty: " + pIds);
