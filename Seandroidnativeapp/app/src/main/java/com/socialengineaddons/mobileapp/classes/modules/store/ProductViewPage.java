...
import com.socialengineaddons.mobileapp.classes.modules.store.adapters.ProductPagerAdapter;
import com.socialengineaddons.mobileapp.classes.modules.store.adapters.ProductViewAdapter;
...
import com.socialengineaddons.mobileapp.classes.modules.store.utils.CartPreferences;
import com.socialengineaddons.mobileapp.classes.modules.store.utils.Product;
import com.socialengineaddons.mobileapp.classes.modules.store.utils.ProductInfoModel;
...
public class ProductViewPage extends AppCompatActivity implements ObservableScrollViewCallbacks,
    ...
    public void getViews() {
        ...
        if (PreferencesUtils.isPrimeMessengerEnabled(mContext)) {
            messageDrawable = ContextCompat.getDrawable(mContext, R.drawable.ic_prime_messenger);
        } else {
            messageDrawable = ContextCompat.getDrawable(mContext, R.drawable.ic_message);

        }
        messageDrawable.mutate();
        messageDrawable.setColorFilter(ContextCompat.getColor(mContext, R.color.grey),
                PorterDuff.Mode.SRC_ATOP);
    ...
    public void setViewDetails(JSONObject jsonObject) {
        ...
        String descriptionText = mBody.optString("body");
        if (mProductInfoObject != null) {
            ...
            if (!mProductInfoObject.optString("description").isEmpty()) {
                descriptionText = mProductInfoObject.optString("description");
            }
        ...
        if (descriptionText != null && !descriptionText.isEmpty())
            mDescriptionText.loadDataWithBaseURL("file:///android_asset/",
                    GlobalFunctions.getHtmlData(this, descriptionText, true), "text/html", "utf-8", null);
    ...
    public void setUpPriceForProduct() {
        ...
        if (mProductInfoObject != null) {
            if (mProductInfoObject.optJSONObject("price").optInt("discount") != 0) {
                ...
                mProductPrice.setText(CurrencyUtils.getCurrencyConvertedValue(mContext,
                ...
                mProductDefaultPrice.setText(CurrencyUtils.getCurrencyConvertedValue(mContext,
    ...
    public void setUpShippingDetails() {
        if (mShippingMethodsObject != null && mShippingMethodsObject.optInt("totalItemCount") > 0) {
            ...
            for (int i = 0; i < methodArray.length(); i++) {
                ...
                methodPrice.setText("   :   " + CurrencyUtils.getCurrencyConvertedValue(mContext,
                        mDefaultCurrencyCode, methodObject.optDouble("shipping_price")));

                if (priceRateObject != null && priceRateObject.optInt("type") == 0) {
                    methodRate.setText("   :   " + CurrencyUtils.getCurrencyConvertedValue(mContext,
                ...
                if (jsonObject.optJSONObject("multiOptions") != null) {
                    ...
                    if (keys != null) {
                        while (keys.hasNext()) {
                            ...
                            if (valueObject != null) {
                                list.add(new SheetItemModel(valueObject, key, null));
                            }
                        }
                    }
        ...
        mAppConst.postJsonResponseForUrl(UrlUtil.ADD_TO_CART_URL + mStoreId + "/" + mProductId,
                postParams, new OnResponseListener() {
                    ...
                    public void onTaskCompleted(JSONObject jsonObject) throws JSONException {
                        ...
                        Toast.makeText(mContext, getResources().getString(R.string.product_added_to_cart_success_message), Toast.LENGTH_SHORT).show();
