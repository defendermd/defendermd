...
public class ShippingMethods extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Drawable fabBtn = ContextCompat.getDrawable(this, R.drawable.ic_action_new).mutate();
        fabBtn.setColorFilter(getResources().getColor(R.color.white), PorterDuff.Mode.SRC_ATOP);
        FloatingActionButton fab = findViewById(R.id.fab_add_shipping_method);
        fab.setImageDrawable(fabBtn);
