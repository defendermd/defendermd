...
import com.socialengineaddons.mobileapp.classes.modules.store.utils.CartInfoModel;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        if(mStoreInfo.getProductsArray() != null) {
            ...
            cartViewHolder.subTotalAmount.setText(
                    CurrencyUtils.getCurrencyConvertedValue(mContext,
                            mStoreInfo.getDefaultCurrency(), mStoreInfo.getSubTotal()));

            if(mStoreInfo.getStoreTax() != 0) {
                cartViewHolder.taxVat.setText(CurrencyUtils.getCurrencyConvertedValue(mContext,
            ...
            if(mStoreInfo.getStoreTax() == 0 && mStoreInfo.getShippingMethodName() == null){
                ...
                cartViewHolder.totalAmount.setText(CurrencyUtils.getCurrencyConvertedValue(mContext,
                        mStoreInfo.getDefaultCurrency(),
            ...
            if(mStoreInfo.getShippingMethodName() != null && !mStoreInfo.getShippingMethodName().isEmpty()){
                ...
                cartViewHolder.shippingAmount.setText(CurrencyUtils.getCurrencyConvertedValue(mContext,
                        mStoreInfo.getDefaultCurrency(),
