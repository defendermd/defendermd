        ...
        switch (holder.getItemViewType()) {
            case VIEW_ITEM:
                ...
                if(mProductInfo.isDiscountAvailable() == 1) {
                    ...
                    productViewHolder.productDiscountedPrice.setText(CurrencyUtils.getCurrencyConvertedValue(
                            mContext, mProductInfo.getCurrency(),mProductInfo.getProductPrice()));

                    productViewHolder.priceView.setText(CurrencyUtils.getCurrencyConvertedValue(
                            mContext, mProductInfo.getCurrency(),mProductInfo.getDiscountedPrice()));
