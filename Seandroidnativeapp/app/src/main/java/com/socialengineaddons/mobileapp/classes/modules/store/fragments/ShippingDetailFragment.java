...
package com.socialengineaddons.mobileapp.classes.modules.store.fragments;
            ...
            for (int i = 0; i < mBillingForm.length(); i++) {
                ...
                switch (object.optString("name")) {
                    ...
                    case "country_billing":
                        if (object.optJSONObject("multiOptions") != null) {
                            mBillingCountry = mBillingDetails.optString("country_billing");
                            mBCountry.setText(object.optJSONObject("multiOptions").optString(mBillingCountry));
                        }
                        mRootView.findViewById(R.id.layout_bill_country).setVisibility(View.VISIBLE);
                        break;
                    case "state_billing":
                        if (object.optJSONArray("multiOptions") != null) {
                            mBillingState = mBillingDetails.optString("state_billing");
                            mBRegion.setText(object.optJSONArray("multiOptions").optString(mBillingDetails.optInt("state_billing")  + 1));
                        }
                ...
                switch (object.optString("name")) {
                    ...
                    case "country_shipping":
                        if (object.optJSONObject("multiOptions") != null) {
                            ...
                            mSCountry.setText(object.optJSONObject("multiOptions").optString(mShippingCountry));
                        }
                    ...
                    case "state_shipping":
                        if (object.optJSONArray("multiOptions") != null) {
                            ...
                            mSRegion.setText(object.optJSONArray("multiOptions").optString(mShippingDetails.optInt("state_shipping") + 1));
                        }
