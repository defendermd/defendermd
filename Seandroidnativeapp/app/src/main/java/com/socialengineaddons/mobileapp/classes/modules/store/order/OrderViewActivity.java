...
package com.socialengineaddons.mobileapp.classes.modules.store.order;
    ...
    public void setOrderDetails(JSONObject orderDetails){
        ...
        if(storeObject != null){
            ...
            while( keys.hasNext() ) {
                ...
                totalAmount.setText(CurrencyUtils.getCurrencyConvertedValue(this, currency,
                        newObject.optDouble("total")));

                taxVat.setText(CurrencyUtils.getCurrencyConvertedValue(this, currency,
                        newObject.optDouble("tax")));

                shippingAmount.setText(CurrencyUtils.getCurrencyConvertedValue(this,
                ...
                if(productArray != null) {
                    for(int i = 0;i<productArray.length();i++) {
                        ...
                        productPrice.setText(CurrencyUtils.getCurrencyConvertedValue(this,
                                currency,productObject.optDouble("unitPrice")));

                        productTax.setText("   :   " + CurrencyUtils.getCurrencyConvertedValue(this, currency,
                                productObject.optDouble("tax")));

                        productTotal.setText("   :   " + CurrencyUtils.getCurrencyConvertedValue(this, currency,
                                productObject.optDouble("price")));
    ...
    public void showOrderSummery(JSONObject amountFieldObject, String currency){
        ...
        while( keys.hasNext() ) {
            ...
            labelView.setPadding(getResources().getDimensionPixelSize(R.dimen.offset_distance),
                    ...
                    getResources().getDimensionPixelSize(R.dimen.drawer_item_top_padding));
            mainText.setText(CurrencyUtils.getCurrencyConvertedValue(this, currency,
                    amountFieldObject.optDouble(key)));
