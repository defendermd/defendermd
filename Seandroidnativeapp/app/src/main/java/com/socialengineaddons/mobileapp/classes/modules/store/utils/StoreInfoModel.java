...
public class StoreInfoModel {
    ...
    private JSONObject sliderObject;

    public StoreInfoModel(){

    }

    public StoreInfoModel(JSONObject sliderDataObject) {
        this.sliderObject = sliderDataObject;
    }
    ...
    public void setSliderObject(JSONObject sliderObject) {
