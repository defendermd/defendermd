...
import com.socialengineaddons.mobileapp.classes.modules.store.StoreViewPage;
import com.socialengineaddons.mobileapp.classes.modules.store.fragments.BrowseProductFragment;
import com.socialengineaddons.mobileapp.classes.modules.store.fragments.BrowseStoreFragment;
import com.socialengineaddons.mobileapp.classes.modules.store.fragments.ManageStoreFragment;
import com.socialengineaddons.mobileapp.classes.modules.store.order.BrowseOrderFragment;
import com.socialengineaddons.mobileapp.classes.modules.store.order.OrderHomeFragment;
import com.socialengineaddons.mobileapp.classes.modules.store.order.OrderViewActivity;
import com.socialengineaddons.mobileapp.classes.modules.wishlist.ProductWishList;
import com.socialengineaddons.mobileapp.classes.modules.wishlist.WishlistView;
...
public class StoreUtil {
    ...
    public static Intent getStoreViewPageIntent(Context context, String store_id, JSONObject storeDetails) {
        Intent intent = new Intent(context, StoreViewPage.class);
        intent.putExtra("store_id", store_id);
