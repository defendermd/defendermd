...
public class EditPersonalInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (getArguments() != null) {
            ...
            fillRequiredFieldRequest = getArguments().getBoolean(ConstantVariables.FILL_REQUIRED_FIELD, false);
        }
        ...
        if (mEditProfileUrl != null) {
            ...
            mAppConst.getJsonResponseFromUrl(mEditProfileUrl, new OnResponseListener() {
                ...
                public void onTaskCompleted(JSONObject jsonObject) {
                    ...
                    if (fillRequiredFieldRequest && !EditProfileActivity.isProfileUpdated) {
                        EditProfile();
                    }
        ...
        if (postParams != null) {
            ...
            mAppConst.putResponseForUrl(mEditProfileUrl, postParams, new OnResponseListener() {
                ...
                public void onTaskCompleted(JSONObject jsonObject) {
                    ...
                    SnackbarUtils.displaySnackbarLongWithListener(((Activity) mContext).findViewById(android.R.id.content),
