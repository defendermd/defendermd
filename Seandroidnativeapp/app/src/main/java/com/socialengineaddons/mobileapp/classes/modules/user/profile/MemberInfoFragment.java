...
public class MemberInfoFragment extends BaseFragment {
    ...
    private NestedScrollView nsvMemberInfoWrapper;
    ...
    public void setNestedScrollingEnabled(boolean enabled) {
        nsvMemberInfoWrapper.setNestedScrollingEnabled(enabled);
    }
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        nsvMemberInfoWrapper = mRootView.findViewById(R.id.nsvMemberInfoWrapper);
        ...
        if(bundle != null){
            ...
            moduleName = bundle.getString(ConstantVariables.EXTRA_MODULE_TYPE);
        ...
        if ((getArguments() != null && !getArguments().getBoolean(ConstantVariables.IS_PROFILE_PAGE_REQUEST)
                || (infoType.equals("overview") && moduleName != null && moduleName.equals(ConstantVariables.SITE_PAGE_MENU_TITLE)))) {
            makeRequest();
        }
        if (getArguments() != null && !getArguments().getBoolean(ConstantVariables.IS_PROFILE_PAGE_REQUEST)) {
            ...
            public void onTaskCompleted(JSONObject jsonObject) {
                ...
                if (mBody != null) {
                    ...
                    switch (infoType) {
                        ...
                        default:
                            // Display no information message if response have empty body
                            // else display profile information
                            int marginBottom = (int ) mContext.getResources().getDimension(R.dimen.dimen_100dp);
                            if (!mBody.has("body")) {
                                ...
                                for (int i = 0; i < mBody.length(); i++) {
                                    ...
                                    try {
                                        ...
                                        if (fieldJsonObject != null) {
                                            ...
                                            for (int j = 0; j < fieldJsonObject.length(); j++) {
                                                ...
                                                if (value != null && !value.isEmpty() && !value.equals("null")) {
                                                    if (!isHeadingCreated) {
                                                        ...
                                                        headingtextView.setPadding(marginTop, marginTop - 10, marginTop, marginTop);
                                            ...
                                            mMemberInfoLayout.setPadding(marginTop, marginTop / 2, marginTop, marginBottom);
                                        }
