...
import com.socialengineaddons.mobileapp.classes.common.formgenerator.FormTextView;
import com.socialengineaddons.mobileapp.classes.common.interfaces.OnResponseUpdateListener;
...
public class MemberSettingsActivity extends FormActivity implements
    ...
    private LinearLayout llSubscriptionView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        llSubscriptionView = findViewById(R.id.subscription_view);
            ...
            mAppConst.getJsonResponseFromUrl(url, new OnResponseListener() {
                ...
                public void onTaskCompleted(JSONObject jsonObject) {
                    ...
                    if (selectedSettingOption.equals("settings_networks")) {
                        ...
                        setSubscriptionView(jsonObject);
    ...
    private void setSubscriptionView(JSONObject jsonObject) {

        int padding15 = (int) mContext.getResources().getDimension(R.dimen.dimen_15dp);

        if (jsonObject.optJSONArray("subscription_form") != null ) {
            menuItem.setVisible(true);
            formContainer.setVisibility(View.VISIBLE);
            llSubscriptionView.setVisibility(View.GONE);
            ...
            llSubscriptionView.setVisibility(View.VISIBLE);
            ...
            tvSubscriptionPlan.setText(mContext.getResources().getString(R.string.subscription_plan_content_prefix)
                    + " " + jsonObject.optString("current_subsciption_plan"));
            tvSubscriptionPlan.setPadding(padding15, padding15, padding15, padding15);
            tvSubscriptionPlan.setTextSize(TypedValue.COMPLEX_UNIT_PX, mContext.getResources().getDimension(R.dimen.body_medium_font_size));
            tvSubscriptionPlan.setTextColor(ContextCompat.getColor(mContext, R.color.black));
            ...
            tvSubscriptionPrice.setText(mContext.getResources().getString(R.string.subscription_plan_price_prefix)
                    + " " + jsonObject.optString("current_subsciption_price"));
            tvSubscriptionPrice.setPadding(padding15, 0, padding15, padding15);
            tvSubscriptionPrice.setTextSize(TypedValue.COMPLEX_UNIT_PX, mContext.getResources().getDimension(R.dimen.body_medium_font_size));
            tvSubscriptionPrice.setTextColor(ContextCompat.getColor(mContext, R.color.black));


            llSubscriptionView.addView(tvSubscriptionPlan);
            llSubscriptionView.addView(tvSubscriptionPrice);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuItem.setTitle(mContext.getResources().getString(R.string.save_menu_title));
        if (selectedSettingOption.equals("settings_subscription")) {
            menuItem.setTitle(getResources().getString(R.string.subscription_upgrade_title));
        } else if (selectedSettingOption.equals("reset_password")){
            menuItem.setTitle(getResources().getString(R.string.reset_password_submit_button));
        }
        return true;
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == ConstantVariables.PAYMENT_FAILED_ACTIVITY_CODE) {
            ...
            PreferencesUtils.updatePaidMemberStatus(mContext,1);
