...
public class FieldsFormActivity extends FormActivity {
    ...
    private JSONObject mFieldsJsonObject, mSubProfileFields;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (getIntent().hasExtra("subProfileFields")) {
                mSubProfileFields = new JSONObject(getIntent().getStringExtra("subProfileFields"));
            }
        ...
        if(mFieldsJsonObject != null && mFieldsJsonObject.length() > 0) {
            ...
            mAccountFormView.addView(generateForm(mFieldsJsonObject, mSubProfileFields, false, ConstantVariables.SIGN_UP_FIELDS, firstName, lastName));
        } else {
            ...
            mAppConst.postLoginSignUpRequest(UrlUtil.SIGNUP_OTP_SEND_URL, params, new OnResponseListener() {
                ...
                public void onTaskCompleted(JSONObject jsonObject) throws JSONException {
                    ...
                    if (jsonObject != null) {
                        ...
                        int keyboardType = otpJsonObject.optInt("type");
