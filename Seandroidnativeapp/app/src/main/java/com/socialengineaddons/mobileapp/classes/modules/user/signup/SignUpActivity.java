...
public class SignUpActivity extends FormActivity {
    ...
    private JSONObject mFieldJsonObject, mSelectedFieldsObject, loginFromObject, subProfileObject;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            if (loginType != null && !loginType.isEmpty()) {
                ...
                subProfileObject = loginFromObject.optJSONObject("subprofilefields");
                mAccountFormView.addView(populate(loginFromObject, "signup_account"));


            } else {
                mFieldJsonObject = mResponseObject.optJSONObject("fields");
                subProfileObject = mResponseObject.optJSONObject("subprofilefields");
            ...
            mAppConst.postJsonResponseForUrl(accountValidationUrl, postParams, new OnResponseListener() {
                ...
                public void onTaskCompleted(JSONObject jsonObject) {
                    ...
                    if (!isError) {
                        ...
                        if (subProfileObject != null) {
                            fieldsIntent.putExtra("subProfileFields", subProfileObject.toString());
                        }
