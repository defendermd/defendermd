...
package com.socialengineaddons.mobileapp.classes.modules.user.staticpages;
...
public class FooterMenusFragment extends Fragment {
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        if (mCurrentSelectedOption.equals("contact_us")) {
            postContact = menu.findItem(R.id.post_contact);
    ...
    public void postContactForm() {
        ...
        emailFieldValue = emailField.getText().toString().trim();
