...
import com.socialengineaddons.mobileapp.classes.common.interfaces.OnVideoSourceLoadCompleteListener;
import com.socialengineaddons.mobileapp.classes.common.ui.ActionIconThemedTextView;
import com.socialengineaddons.mobileapp.classes.common.ui.CustomVideoView;
    ...
    private Runnable runnableCode = new Runnable() {
        ...
        public void run() {
            ...
            if (liveReactions.size() > 0 && liveReactionPosition < liveReactions.size()
                ...
                float y1 = loadingProgress.getY() - 70;
