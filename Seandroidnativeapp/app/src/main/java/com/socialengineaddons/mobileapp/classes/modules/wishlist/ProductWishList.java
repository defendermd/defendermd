package com.socialengineaddons.mobileapp.classes.modules.wishlist;
...
public class ProductWishList extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (PreferencesUtils.getCurrentSelectedModule(mContext) != null &&
                !PreferencesUtils.getCurrentSelectedModule(mContext).equals("sitestoreproduct_wishlist")) {
            PreferencesUtils.updateCurrentModule(mContext, "sitestoreproduct_wishlist");
        }

        mBrowseWishlistUrl = UrlUtil.PRODUCT_WISHLIST_URL + "&page=" + mLoadingPageNo;
        ...
        mBrowseWishlistAdapter = new AdvModulesRecyclerViewAdapter(mContext, mBrowseItemList, "wishlist", 0,
                ProductWishList.this, new OnItemClickListener() {
                    @Override
                    public void onItemClick(View view, int position) {
                        ...
                        mainIntent.putExtra(ConstantVariables.EXTRA_MODULE_TYPE,"sitestoreproduct_wishlist");
                        mainIntent.putExtra(ConstantVariables.URL_STRING,
                                UrlUtil.PRODUCT_WISHLIST_VIEW_URL+listItems.getmListItemId());
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (limit == totalItemCount && !isLoading) {
                    ...
                    if (limit >= AppConstant.LIMIT && (AppConstant.LIMIT * mLoadingPageNo)
                        ...
                        String url = UrlUtil.PRODUCT_WISHLIST_URL + "&page=" + mLoadingPageNo;
    ...
    public void makeRequest() {
        try {
            ...
            mLoadingPageNo = 1;
            if(!isSearchTextSubmitted){
                mBrowseWishlistUrl = UrlUtil.PRODUCT_WISHLIST_URL + "&page=" + mLoadingPageNo + "&orderby=wishlist_id";

                // Don't show data in case of searching.
                mBrowseItemList.clear();
                String tempData = DataStorage.getResponseFromLocalStorage(mContext, DataStorage.PRODUCT_WISHLIST_FILE);
                if(tempData != null) {
            ...
            mAppConst.getJsonResponseFromUrl(mBrowseWishlistUrl, new OnResponseListener() {
                ...
                public void onTaskCompleted(JSONObject jsonObject) {
                    ...
                    if(!isSearchTextSubmitted ) {
                        DataStorage.createTempFile(mContext,DataStorage.PRODUCT_WISHLIST_FILE, jsonObject.toString());
                    }
