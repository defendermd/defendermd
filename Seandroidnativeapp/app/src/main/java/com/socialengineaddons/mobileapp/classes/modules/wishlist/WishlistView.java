...
public class WishlistView extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,
    ...
    private int mLoadingPageNo = 1, mWishListId, ownerId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentModule != null && currentModule.equals("sitestoreproduct_wishlist")) {
    ...
    public void addItemsToList(JSONObject jsonObject) {
        ...
        ownerId = responseObject.optInt("owner_id");
        ...
        mBrowseListItems.setUserId(responseObject.optInt("owner_id"));
        mBrowseListItems.setUserDisplayName(responseObject.optString("owner_title"));
        mBrowseListItems.setUserProfileImageUrl(responseObject.optString("owner_image_normal"));
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        menu.clear();
        if (mGutterMenus != null) {
            mGutterMenuUtils.showOptionMenus(menu, mGutterMenus, currentModule, mBrowseListItems, ownerId);
        }
