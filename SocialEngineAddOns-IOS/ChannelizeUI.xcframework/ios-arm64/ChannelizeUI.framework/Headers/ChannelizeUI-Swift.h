...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ChannelizeUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC12ChannelizeUI11Cancellable")
...
SWIFT_CLASS("_TtC12ChannelizeUI15EZYGradientView")
...
SWIFT_CLASS("_TtC12ChannelizeUI16SwiftLinkPreview")
...
@interface SwiftLinkPreview (SWIFT_EXTENSION(ChannelizeUI)) <NSURLSessionDataDelegate>
