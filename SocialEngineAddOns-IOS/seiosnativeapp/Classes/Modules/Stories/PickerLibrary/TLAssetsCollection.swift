...
public struct TLPHAsset {
    ...
    public var isVideoSelected = false
    public var viewMoving = UIView()
    public var viewDrawing = TouchDrawView()
    public var isViewDrawVisible = false
    public var colorAlpha: CGFloat = 0.0
    public var deltaWidth: CGFloat = 0.0
    public var imgPassAPI = UIImage()
    public var imgPassMovingAPI = UIImage()
    public var imgPassdrawingAPI = UIImage()
    public var imgFinalPassAPI = UIImage()
    public var imgFinalTransparentVideoImage = UIImage()
    public var strDescription = ""
    public var strVideoPath: URL!
    public var videoData: Data!
    public var videoDuration: Double = 0.0
    public var imgFilter = UIImage()
    public var imgCrop = UIImage()
