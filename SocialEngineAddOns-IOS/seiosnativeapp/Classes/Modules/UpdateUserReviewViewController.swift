...
//
//  UpdateUserReviewViewController.swift
//  seiosnativeapp
//
...
class UpdateUserReviewViewController: UIViewController, UIGestureRecognizerDelegate, FloatRatingViewDelegate,UITextViewDelegate
{
    ...
    override func viewDidLoad()
    {
        ...
        self.title = NSLocalizedString("Update User Review",  comment: "")
        
        btnCreate = UIBarButtonItem(title: "\(sendReviewIcon)", style: UIBarButtonItem.Style.done , target:self , action: #selector(UpdateUserReviewViewController.send))
        ...
        let tapView = UITapGestureRecognizer(target: self, action: #selector(UpdateUserReviewViewController.cancel))
        ...
        let tap:UITapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(UpdateUserReviewViewController.resignKeyboard))
        tap.delegate = self
    ...
    func GetReview()
    {
        ...
        //print("Below is the request url ")
        
        parameters = ["review_id":"\(Review_id)", "listing_id":"\(listing_id)", "listingtype_id": String(listingtype_id)]
...
//        view.addSubview(spinner)
        ...
        {
            showToast(message: "Feild is empty", controller: self)
        }
    }
}
